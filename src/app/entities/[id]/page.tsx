...
export default function EntityProfilePage() {
  ...
  const baseData = {
    ...
    type: "Fine Dining",
    location: "45 MG Road, BKC, Mumbai 400051",
    rating: 4.8,
    reviews: 124,
    verified: true,
  ...
  const butcherData = {
    ...
    location: "SV Road, Andheri West, Mumbai 400058",
    rating: 4.9,
    reviews: 187,
    verifiedBy: "HMC Global",
    description: "Al-Barakah Premium Meats is Mumbai's leading HMC-certified butcher, sourcing only from traceable, ethical farms. We offer custom cuts, dry-aged beef, grass-fed lamb, and weekly subscription boxes — all 100% halal.",
    items: [
  ...
  const eventsData = {
    ...
    description: "Grand Halal Ballroom is Mumbai's premier Shariah-compliant event space. We host weddings, Aqeeqahs, corporate functions, and community events with full segregation options, alcohol-free bars, and dedicated Wudu facilities.",
    items: [
  ...
  const fashionData = {
    ...
    description: "Al-Hayat is Mumbai's leading modest fashion label, offering premium abayas, hijabs, and modest occasion wear. Ethically sourced, fully opaque fabrics, and cuts designed in consultation with Muslim women.",
    items: [
  ...
  const groceryData = {
    ...
    location: "Govandi, Mumbai 400088",
    rating: 4.7,
    reviews: 430,
  ...
  const hotelData = {
    ...
    description: "The Madinah Suite Hotel is Mumbai's premier halal-certified boutique hotel. Strictly alcohol-free, pork-free, with in-room prayer mats, Qibla direction, halal breakfast, and a private Muslim-friendly rooftop pool.",
    items: [
