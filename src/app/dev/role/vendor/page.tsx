    ...
    <div className="container mx-auto p-4 sm:p-6 space-y-6 sm:space-y-10 max-w-6xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-4xl font-black font-headline text-foreground tracking-tight">Business Hub</h1>
        ...
        {kpis.map((kpi, i) => (
          <Card key={i} className="border-none shadow-sm rounded-3xl bg-card p-2 group hover:shadow-md transition-all">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest leading-none">{kpi.label}</span>
              <kpi.icon className="h-4 w-4 text-muted-foreground group-hover:text-primary transition-colors" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-black text-foreground tracking-tighter">{kpi.value}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          <section className="space-y-4">
            <div className="flex items-center justify-between px-2">
              <h2 className="text-xl font-black text-foreground">Your Active Establishments</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <Card key={i} className="rounded-[2.5rem] border-none shadow-sm bg-card overflow-hidden group hover:shadow-xl transition-all border-2 border-transparent hover:border-primary/10 cursor-pointer">
                  <div className="p-8 space-y-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-black text-foreground tracking-tight leading-tight">{biz.name}</h3>
                      <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">{biz.type} Vertical</p>
                    </div>
                    <div className="pt-6 border-t border-border flex items-center justify-between">
                      <div className="space-y-0.5">
                        <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest leading-none mb-1">MTD Sales</p>
                        <p className="text-xl font-black text-foreground">{biz.sales}</p>
                      </div>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-xl bg-zinc-900 text-white p-12 overflow-hidden relative">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button variant="outline" className="border-white/20 text-white hover:bg-card/10 rounded-2xl h-16 px-10 font-black uppercase text-sm tracking-widest">
                  Download Guide
                </Button>
              </div>
            </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8">
            ...
            <CardContent className="px-0 space-y-6">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-4 rounded-3xl bg-muted border border-transparent hover:border-primary/10 transition-all cursor-pointer group">
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-6">
            <h3 className="text-xl font-black text-foreground">Revenue Velocity</h3>
            <div className="space-y-2">
              ...
              <p className="text-[10px] font-bold text-muted-foreground mt-2">Target: ₹5.5M / MTD: ₹4.2M</p>
            </div>
            <div className="pt-4 border-t border-border space-y-4">
              <div className="flex justify-between items-center text-sm font-bold text-foreground">
                <span>Avg. Basket Size</span>
                <span className="font-black text-foreground">₹850</span>
              </div>
              <div className="flex justify-between items-center text-sm font-bold text-foreground">
                <span>Customer Loyalty</span>
                <span className="font-black text-foreground">62%</span>
              </div>
            </div>
          </Card>
        </div>
