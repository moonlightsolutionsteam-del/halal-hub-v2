    ...
    <div className="min-h-screen bg-background selection:bg-blue-500/10">
      ...
      <header className="sticky top-0 z-50 bg-card/80 backdrop-blur-md border-b px-6 h-20 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-6">
          <Link href="/">
            <Button variant="ghost" size="icon" className="rounded-2xl hover:bg-muted border shadow-sm h-12 w-12 transition-transform active:scale-90">
              <ArrowLeft className="h-5 w-5 text-muted-foreground" />
            </Button>
          </Link>
          <div className="space-y-0.5">
            <h1 className="text-2xl font-black font-headline text-foreground tracking-tight">Creator Profile</h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/vendor/creative/dashboard">
            <Button variant="outline" className="hidden md:flex rounded-2xl h-12 px-6 border-2 font-black uppercase text-[10px] tracking-widest bg-card hover:bg-muted gap-2 shadow-sm">
      ...
      <div className="relative">
        ...
        <div className="container mx-auto max-w-5xl px-6 -mt-32 relative z-10">
            ...
            <div className="flex-1 flex flex-col md:flex-row justify-between items-start md:items-end w-full gap-8 pb-4">
              <div className="space-y-3">
                <div className="flex flex-wrap items-center gap-3">
                  <h2 className="text-5xl font-black text-foreground drop-shadow-sm font-headline tracking-tighter">Shaykh Hamza</h2>
                ...
                <div className="flex flex-wrap items-center gap-6 text-muted-foreground font-bold">
                  ...
                  <div className="flex items-center gap-2 bg-muted px-3 py-1 rounded-full text-xs text-muted-foreground">
                    <MapPin className="h-3.5 w-3.5 text-muted-foreground" /> London, UK
                  </div>
                  <div className="flex items-center gap-2 bg-muted px-3 py-1 rounded-full text-xs text-muted-foreground">
                    <Globe className="h-3.5 w-3.5 text-muted-foreground" /> iman-hub.com
                  </div>
                </div>
              </div>
              <div className="flex flex-wrap gap-3 w-full md:w-auto">
                ...
                <Button variant="outline" className="flex-1 md:flex-none h-16 px-10 rounded-[1.5rem] border-2 border-border font-black uppercase text-sm tracking-widest bg-card hover:bg-muted transition-all shadow-sm">
                  <MessageSquare className="h-5 w-5 mr-2" /> Message
                </Button>
                <Button variant="outline" size="icon" className="h-16 w-16 rounded-[1.5rem] border-2 border-border bg-card text-amber-500 shadow-sm hover:text-amber-600 transition-all">
          ...
          {/* Stats Ribbon */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 py-12 border-y border-border bg-card/50 backdrop-blur-sm rounded-[3rem] px-10 shadow-sm border border-white">
            {[
              ...
              <div key={i} className="flex flex-col items-center sm:items-start gap-3 group cursor-default text-center sm:text-left">
                ...
                <div className="space-y-0.5">
                  <p className="text-3xl font-black text-foreground tracking-tighter leading-none">{stat.value}</p>
          ...
          <Tabs defaultValue="reels" className="w-full mt-16">
            <TabsList className="bg-transparent h-14 w-full p-0 gap-12 justify-start border-b-2 rounded-none mb-12 overflow-x-auto no-scrollbar">
              <TabsTrigger value="reels" className="px-0 pb-4 h-full rounded-none border-b-4 border-transparent data-[state=active]:border-blue-600 data-[state=active]:bg-transparent text-sm font-black uppercase tracking-[0.2em] text-muted-foreground data-[state=active]:text-foreground transition-all">Reels</TabsTrigger>
              <TabsTrigger value="feed" className="px-0 pb-4 h-full rounded-none border-b-4 border-transparent data-[state=active]:border-blue-600 data-[state=active]:bg-transparent text-sm font-black uppercase tracking-[0.2em] text-muted-foreground data-[state=active]:text-foreground transition-all">Feed</TabsTrigger>
              <TabsTrigger value="podcasts" className="px-0 pb-4 h-full rounded-none border-b-4 border-transparent data-[state=active]:border-blue-600 data-[state=active]:bg-transparent text-sm font-black uppercase tracking-[0.2em] text-muted-foreground data-[state=active]:text-foreground transition-all">Podcasts</TabsTrigger>
              <TabsTrigger value="about" className="px-0 pb-4 h-full rounded-none border-b-4 border-transparent data-[state=active]:border-blue-600 data-[state=active]:bg-transparent text-sm font-black uppercase tracking-[0.2em] text-muted-foreground data-[state=active]:text-foreground transition-all">About</TabsTrigger>
            </TabsList>
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                  <Card key={i} className="group rounded-[3rem] border-none shadow-sm overflow-hidden aspect-[9/16] relative cursor-pointer hover:shadow-2xl transition-all duration-700">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="h-16 w-16 rounded-full bg-card/20 backdrop-blur-md flex items-center justify-center text-white scale-50 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-500 border border-white/30 shadow-2xl">
                ...
                {[1, 2].map(i => (
                  <Card key={i} className="rounded-[3.5rem] border-none shadow-sm bg-card overflow-hidden p-12 flex flex-col md:flex-row gap-12 hover:shadow-2xl transition-all duration-700 border border-transparent hover:border-blue-100 group/post">
                    ...
                    <div className="flex-1 flex flex-col justify-between py-4">
                      <div className="space-y-8">
                        <div className="flex justify-between items-start">
                          <div className="space-y-2">
                            <h3 className="text-4xl font-black text-foreground tracking-tighter leading-tight group-hover/post:text-blue-600 transition-colors">Lessons from the Seerah</h3>
                            <p className="text-[11px] font-black text-muted-foreground uppercase tracking-[0.3em]">Published on Oct 24, 2024</p>
                          </div>
                          <Button variant="ghost" size="icon" className="rounded-2xl h-12 w-12 bg-muted hover:bg-blue-50 text-muted-foreground hover:text-blue-600 transition-all"><Bookmark className="h-6 w-6" /></Button>
                        </div>
                        <p className="text-muted-foreground text-xl font-medium leading-relaxed line-clamp-3 italic">
                      ...
                      <div className="flex items-center justify-between pt-12 border-t-2 border-border">
                        <div className="flex gap-10">
                          <button className="flex items-center gap-3 text-xs font-black text-muted-foreground uppercase tracking-widest hover:text-rose-500 transition-colors">
                            <Heart className="h-6 w-6" /> 2.4k
                          </button>
                          <button className="flex items-center gap-3 text-xs font-black text-muted-foreground uppercase tracking-widest hover:text-blue-500 transition-colors">
            ...
            <TabsContent value="about" className="m-0 grid grid-cols-1 lg:grid-cols-12 gap-16 animate-in fade-in slide-in-from-bottom-2 duration-500 pb-24">
              <div className="lg:col-span-8 space-y-16">
                <section className="space-y-8">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-3xl font-black text-foreground tracking-tight leading-none">The Mission</h3>
                  </div>
                  <p className="text-2xl text-muted-foreground font-medium leading-relaxed italic border-l-8 border-blue-50 pl-10">
                ...
                <section className="space-y-10">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-3xl font-black text-foreground tracking-tight leading-none">Verified Collaborations</h3>
                  </div>
                    ...
                    {[
                      ...
                      <Card key={i} className="rounded-[3rem] border-none shadow-sm bg-card overflow-hidden group border border-transparent hover:border-emerald-100 hover:shadow-xl transition-all duration-500 cursor-pointer">
                        <div className="p-8 flex items-center gap-8">
                          ...
                          <ArrowUpRight className="h-6 w-6 text-muted-foreground ml-auto group-hover:text-emerald-600 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all" />
                        </div>
                      </Card>
                    ))}
                  </div>
              ...
              <div className="lg:col-span-4 space-y-12">
                <Card className="rounded-[3.5rem] border-none shadow-2xl bg-card p-12 space-y-10 border border-border relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-10 opacity-5">
                    <Wallet className="h-32 w-32 text-blue-600" />
                  </div>
                  <div className="space-y-2 relative z-10">
                    <h3 className="text-2xl font-black text-foreground uppercase tracking-tighter">Support the Work</h3>
                  ...
                  <div className="space-y-6 relative z-10">
                    <div className="flex items-center justify-between p-6 bg-blue-50 rounded-[2rem] border-2 border-blue-100 shadow-inner group cursor-pointer hover:bg-blue-100 transition-colors">
                      <div className="flex items-center gap-4">
                        <div className="h-12 w-12 bg-card rounded-2xl flex items-center justify-center text-blue-600 shadow-md transition-transform group-hover:rotate-12">
                    ...
                    <Button className="w-full h-16 rounded-[1.5rem] bg-zinc-900 text-white font-black uppercase text-xs tracking-[0.2em] shadow-2xl hover:bg-blue-600 transition-all active:scale-95">
                      Gift 50 Hub Coins
                    </Button>
                  </div>
                </Card>

                <Card className="rounded-[3.5rem] border-none bg-zinc-900 text-white p-12 space-y-8 relative overflow-hidden shadow-2xl group">
                  <div className="absolute top-0 right-0 p-10 opacity-10 group-hover:scale-110 transition-transform duration-1000">
                    <ShieldCheck className="h-48 w-48 text-blue-400" />
                  </div>
                  <div className="relative z-10 space-y-6">
                    <div className="h-16 w-16 rounded-[1.5rem] bg-card/10 flex items-center justify-center text-blue-400 border border-white/10 shadow-3xl">
                    ...
                    <Button variant="outline" className="w-full h-14 rounded-2xl border-white/20 text-white hover:bg-card/10 font-black text-[10px] uppercase tracking-widest">
      ...
      <Link href="/vendor/creative/dashboard" className="md:hidden fixed bottom-24 right-6 z-50">
        <Button className="h-16 w-16 rounded-full bg-zinc-900 text-white shadow-2xl border-4 border-white active:scale-90 transition-transform">
