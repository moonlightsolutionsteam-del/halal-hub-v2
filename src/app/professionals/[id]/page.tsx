...
const PROFESSIONALS: Record<string, any> = {
  "p1": {
    ...
    website: "https://taiqosmanlaw.com",
    email: "tariq@taiqosmanlaw.com",
    rating: 4.9,
    reviewCount: 87,
    experience: "14 years",
    clients: "500+",
    ...
    tagline: "Protecting Muslim families through expert Islamic and civil law.",
    about: "Br. Tariq Osman is a dual-qualified solicitor and barrister with 14 years of experience in New York and international law. He specialises in family law, Islamic finance contracts, and business law for Muslim-owned enterprises. Tariq is deeply committed to ensuring Muslim families can access legal protection grounded in both civil and Shariah principles.",
    qualifications: [
      { degree: "JD (Juris Doctor)", institution: "Columbia Law School, New York", year: "2010" },
      { degree: "LLM (Islamic Finance Law)", institution: "Harvard Law School", year: "2012" },
      { degree: "Bar Admission (NY)", institution: "New York State Bar", year: "2010" },
    ],
    services: [
      { name: "Family Law Consultation", duration: "60 min", price: "₹350", popular: true },
      { name: "Islamic Finance Contract Review", duration: "90 min", price: "₹600", popular: true },
      { name: "Business Formation & Contracts", duration: "2 sessions", price: "From ₹1,200", popular: false },
      { name: "Nikah Agreement Drafting", duration: "2 sessions", price: "₹800", popular: false },
      { name: "Estate Planning (Wasiyyah)", duration: "3 sessions", price: "From ₹1,500", popular: false },
    ],
    availability: [
      { day: "Monday", slots: ["10:00 AM", "11:00 AM", "2:00 PM", "3:00 PM"] },
      { day: "Wednesday", slots: ["9:00 AM", "11:00 AM", "4:00 PM"] },
      { day: "Friday", slots: ["10:00 AM", "11:00 AM"] },
    ],
    certifications: [
      { label: "New York State Bar Association", status: "Active" },
      { label: "American Muslim Bar Association", status: "Member" },
      { label: "Shariah Law Advisory Board", status: "Certified" },
    ],
    reviews: [
      { user: "Khadijah M.", rating: 5, text: "Br. Tariq handled our Islamic prenuptial agreement with such professionalism and sensitivity. He made the process clear and stress-free." },
      { user: "Ibrahim T.", rating: 5, text: "Outstanding legal mind. He set up our halal business structure correctly from day one and continues to advise us regularly." },
      { user: "Amina S.", rating: 4, text: "Very thorough and responsive. The fees reflect the quality. Highly recommend for any Islamic finance matters." },
    ],
    faqs: [
      { q: "Do you offer free initial consultations?", a: "Yes, I offer a complimentary 15-minute call to assess your legal needs before scheduling a full consultation." },
      { q: "Can you represent clients outside New York?", a: "I primarily practice in New York but can advise on federal matters and connect you with my network of Muslim lawyers across the US." },
      { q: "Do you handle divorce under Islamic law?", a: "Yes, I handle Talaq, Khul', and civil divorce proceedings and can coordinate between the civil court and an Islamic scholar." },
    ],
  },
  "p2": {
    name: "Dr. Amira Hossain",
    title: "General Practitioner & Women's Health",
    specialty: "Medical",
    location: "Bay Ridge",
    city: "Brooklyn, NY",
    country: "USA",
    phone: "+1 718 555 0202",
    website: "https://drahossain.com",
    email: "dr.amira@drahossain.com",
    rating: 4.8,
    reviewCount: 156,
    experience: "10 years",
    clients: "2,000+",
    ...
    color: "bg-violet-600",
    accent: "bg-violet-50 text-violet-600 dark:bg-violet-950/40 dark:text-violet-400",
    tagline: "Compassionate, halal-aware women's healthcare for the Muslim community.",
    about: "Dr. Amira Hossain is a board-certified General Practitioner with a special focus on women's health and preventive medicine. She has served Brooklyn's Muslim community for a decade, offering consultations that are fully respectful of Islamic patient ethics including gender preferences, Awrah considerations, and Sunnah-based wellness guidance.",
    qualifications: [
      { degree: "MBBS", institution: "University of Dhaka Medical College", year: "2014" },
      { degree: "MD (Internal Medicine)", institution: "SUNY Downstate Health Sciences", year: "2018" },
      { degree: "Certificate in Women's Health", institution: "NYU Langone Health", year: "2020" },
    ],
    services: [
      { name: "General Consultation", duration: "30 min", price: "₹150", popular: true },
      { name: "Women's Health Check", duration: "60 min", price: "₹280", popular: true },
      { name: "Home Visit (Brooklyn)", duration: "60 min", price: "₹350", popular: false },
      { name: "Follow-up Consultation", duration: "20 min", price: "₹80", popular: false },
      { name: "Nutrition & Wellness Plan", duration: "45 min", price: "₹200", popular: false },
    ],
    availability: [
    ...
    certifications: [
      { label: "American Board of Internal Medicine", status: "Certified" },
      { label: "New York Medical License", status: "Active" },
      { label: "Halal-Aware Practitioner", status: "Certified" },
    ],
    reviews: [
      { user: "Maryam F.", rating: 5, text: "Dr. Amira is the only doctor I fully trust. She understands my values and never makes me feel uncomfortable about any aspect of my care." },
      { user: "Zainab L.", rating: 5, text: "She came for a home visit when my mother couldn't travel. Absolutely above and beyond. A true community doctor." },
      { user: "Hafsa K.", rating: 4, text: "Knowledgeable, patient, and genuinely caring. The clinic is clean and the staff are respectful. Highly recommended for Muslim women." },
    ],
    faqs: [
      { q: "Do you have female staff throughout?", a: "Yes, our entire clinical staff are female, ensuring a fully comfortable environment for our patients." },
      { q: "Do you offer telehealth?", a: "Yes, video consultations are available for follow-ups and non-emergency cases via a secure HIPAA-compliant platform." },
      { q: "Can you accommodate hijab-wearing patients?", a: "Absolutely. All examination rooms are fully private and our protocols fully respect Islamic modesty requirements." },
    ],
  },
  "p3": {
    name: "Br. Yusuf Karim",
    title: "Chartered Accountant & Islamic Finance Advisor",
    specialty: "Finance",
    location: "Flushing",
    city: "Queens, NY",
    country: "USA",
    phone: "+1 718 555 0303",
    website: "https://yusufkarimcpa.com",
    email: "yusuf@yusufkarimcpa.com",
    rating: 4.7,
    reviewCount: 64,
    experience: "11 years",
    clients: "350+",
    ...
    color: "bg-violet-600",
    accent: "bg-violet-50 text-violet-600 dark:bg-violet-950/40 dark:text-violet-400",
    tagline: "Growing your wealth the halal way — Shariah-compliant finance for modern Muslims.",
    about: "Br. Yusuf Karim is a CPA and Shariah-certified Islamic finance advisor with 11 years of experience. He helps Muslim individuals, families, and small businesses navigate tax planning, Zakat calculation, halal investment portfolios, and interest-free financial structuring. He is currently fully booked but accepting a waitlist.",
    qualifications: [
      { degree: "BBA (Accounting)", institution: "Baruch College, CUNY", year: "2013" },
      { degree: "CPA License (NY)", institution: "New York State CPA Board", year: "2015" },
      { degree: "Certified Islamic Finance Executive (CIFE)", institution: "Ethica Institute of Islamic Finance", year: "2018" },
    ],
    services: [
      { name: "Zakat Calculation", duration: "60 min", price: "₹200", popular: true },
      { name: "Halal Investment Review", duration: "90 min", price: "₹400", popular: true },
      { name: "Tax Planning (Annual)", duration: "Ongoing", price: "From ₹1,000/yr", popular: false },
      { name: "Business Financial Audit", duration: "Ongoing", price: "From ₹2,500", popular: false },
      { name: "Shariah-Compliant Mortgage Review", duration: "2 sessions", price: "₹600", popular: false },
    ],
    availability: [
      { day: "Monday", slots: [] },
      { day: "Wednesday", slots: [] },
    ...
    certifications: [
      { label: "NY CPA License", status: "Active" },
      { label: "Certified Islamic Finance Executive", status: "Certified" },
      { label: "AAOIFI Standards", status: "Trained" },
    ],
    reviews: [
      { user: "Salim A.", rating: 5, text: "Br. Yusuf cleaned up my entire financial situation and restructured everything to be riba-free. Worth every dollar." },
      { user: "Hana B.", rating: 4, text: "Very knowledgeable about Zakat nuances. Gave me clarity I couldn't find anywhere else. Waiting list is long but worth it." },
    ],
    faqs: [
      { q: "Are you currently accepting new clients?", a: "I'm currently fully booked. You can join the waitlist via my website and I'll notify you when a spot opens (typically 4–6 weeks)." },
      { q: "Do you offer Zakat calculation for businesses?", a: "Yes, I calculate Zakat on business assets, inventory, receivables, and investments following the AAOIFI standard." },
      { q: "Can you review my existing investments for Shariah compliance?", a: "Absolutely. I provide a full Shariah screening report for any portfolio, including ETFs, stocks, and real estate." },
    ],
  },
  "p4": {
    name: "Sr. Nadia Al-Sheikh",
    ...
    website: "https://nadiaalsheikhtech.com",
    email: "nadia@nadiaalsheikhtech.com",
    rating: 4.5,
    reviewCount: 38,
    experience: "9 years",
    clients: "80+",
    ...
    color: "bg-violet-600",
    accent: "bg-violet-50 text-violet-600 dark:bg-violet-950/40 dark:text-violet-400",
    tagline: "Building ethical, privacy-first digital solutions for Muslim-owned businesses.",
    about: "Sr. Nadia Al-Sheikh is an independent IT consultant and software architect specialising in SaaS architecture, data privacy, and digital transformation for Muslim-owned startups and small businesses. She has worked with halal e-commerce platforms, Islamic finance fintechs, and Muslim charity organizations.",
    qualifications: [
      { degree: "BSc Computer Science", institution: "Stevens Institute of Technology, NJ", year: "2015" },
      { degree: "MSc Software Engineering", institution: "NYU Tandon School of Engineering", year: "2017" },
      { degree: "AWS Certified Solutions Architect", institution: "Amazon Web Services", year: "2019" },
    ],
    services: [
      { name: "Tech Strategy Consultation", duration: "60 min", price: "₹250", popular: true },
      { name: "SaaS Architecture Review", duration: "Half-day", price: "₹900", popular: true },
      { name: "Data Privacy Audit (GDPR/CCPA)", duration: "Ongoing", price: "From ₹2,000", popular: false },
      { name: "Muslim Startup MVP Build", duration: "Project-based", price: "From ₹5,000", popular: false },
      { name: "Ongoing Tech Advisory", duration: "Monthly retainer", price: "₹800/mo", popular: false },
    ],
    availability: [
      { day: "Tuesday", slots: ["10:00 AM", "2:00 PM", "4:00 PM"] },
      { day: "Thursday", slots: ["10:00 AM", "11:00 AM", "3:00 PM"] },
      { day: "Saturday", slots: ["11:00 AM", "12:00 PM"] },
    ],
    certifications: [
      { label: "AWS Certified Solutions Architect", status: "Active" },
      { label: "Certified Information Privacy Professional (CIPP)", status: "Active" },
    ],
    reviews: [
      { user: "Khalid N.", rating: 5, text: "Sr. Nadia built the entire backend for our halal marketplace from scratch. She delivered on time and the architecture is rock solid." },
      { user: "Layla M.", rating: 4, text: "Excellent consultant — pragmatic and deeply ethical. She pushed back on a feature that would have compromised user data, which I now deeply appreciate." },
    ],
    faqs: [
      { q: "Do you work with non-tech founders?", a: "Yes, absolutely. I specialize in translating business ideas into tech roadmaps for founders with little or no technical background." },
      { q: "Can you build Islamic apps for mosques or charities?", a: "Yes, I have experience building donation platforms, event management tools, and prayer time apps for Islamic organizations." },
      { q: "Do you sign NDAs?", a: "Yes, I sign NDAs before any project discussion. Confidentiality and trust are core to my practice." },
    ],
  },
  "1": {
