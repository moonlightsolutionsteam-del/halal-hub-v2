...
const PROFESSIONALS: Record<string, any> = {
  ...
  "p2": {
    ...
    about: "Dr. Amira Hossain is a board-certified General Practitioner with a special focus on women's health and preventive medicine. She has served Mumbai's Muslim community for a decade, offering consultations that are fully respectful of Islamic patient ethics including gender preferences, Awrah considerations, and Sunnah-based wellness guidance.",
    qualifications: [
    ...
    services: [
      ...
      { name: "Home Visit (Mumbai)", duration: "60 min", price: "₹350", popular: false },
