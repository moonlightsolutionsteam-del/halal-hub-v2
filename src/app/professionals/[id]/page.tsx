...
const PROFESSIONALS: Record<string, any> = {
  "p1": {
    ...
    about: "Br. Tariq Osman is a dual-qualified solicitor and barrister with 14 years of experience in Mumbai and international law. He specialises in family law, Islamic finance contracts, and business law for Muslim-owned enterprises. Tariq is deeply committed to ensuring Muslim families can access legal protection grounded in both civil and Shariah principles.",
    qualifications: [
      { degree: "JD (Juris Doctor)", institution: "Columbia Law School, Mumbai", year: "2010" },
      { degree: "LLM (Islamic Finance Law)", institution: "Harvard Law School", year: "2012" },
      { degree: "Bar Council of Maharashtra", institution: "Mumbai State Bar", year: "2010" },
    ],
    services: [
    ...
    certifications: [
      { label: "Mumbai State Bar Association", status: "Active" },
    ...
    faqs: [
      ...
      { q: "Can you represent clients outside Mumbai?", a: "I primarily practice in Mumbai but can advise on federal matters and connect you with my network of Muslim lawyers across India." },
  ...
  "p2": {
    ...
    certifications: [
      ...
      { label: "Mumbai Medical License", status: "Active" },
  ...
  "p3": {
    ...
    qualifications: [
      ...
      { degree: "CPA License (NY)", institution: "Mumbai State CPA Board", year: "2015" },
