  ...
  return (
    <div className="container mx-auto p-6 space-y-8 max-w-7xl pb-24">
      <div className="space-y-1">
        <h1 className="text-3xl font-black font-headline text-foreground uppercase tracking-tighter">Travel & Tourism</h1>
              ...
              <Table>
                ...
                <TableBody>
                  {MOCK_AGENCIES.map((agency) => (
                    <TableRow key={agency.id} className="border-border hover:bg-muted/50 transition-colors group">
                      <TableCell className="px-8 py-5">
                        <p className="font-black text-foreground text-base">{agency.name}</p>
