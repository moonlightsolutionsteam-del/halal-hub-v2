  ...
  return (
    <div className="container mx-auto p-6 space-y-8 max-w-7xl pb-24">
      <div className="space-y-1">
        <h1 className="text-3xl font-black font-headline text-slate-900">Travel & Tourism</h1>
        <p className="text-muted-foreground font-medium text-lg">Manage travel agencies, pilgrim partners, and global itineraries.</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-bold text-emerald-600 uppercase">+8 since last month</p>
              </div>
            </Card>

            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Pilgrim Partners</span>
            ...
            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Global Bookings</span>
          ...
          <Card className="rounded-[2rem] border-none shadow-sm bg-white overflow-hidden">
            <CardHeader className="p-8 flex flex-row items-center justify-between">
              ...
              <Button size="sm" className="bg-primary hover:bg-primary/90 rounded-xl font-black text-xs h-10 px-6 text-white group">
                Review Queue <ArrowUpRight className="ml-2 h-4 w-4" />
              </Button>
            </CardHeader>
              ...
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    <TableHead className="px-8 h-14 font-black uppercase text-[10px] tracking-widest text-slate-400">Agency Name</TableHead>
                ...
                <TableBody>
                  {[
                    ...
                    <TableRow key={i} className="border-slate-100 hover:bg-slate-50/50 transition-colors">
                      ...
                      <TableCell className="font-bold text-slate-500 text-xs">{item.class}</TableCell>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-20 text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground font-medium max-w-sm mx-auto">
                  Managing the global halal travel network and agency compliance.
                </p>
              </div>
              <Button variant="outline" className="rounded-xl border-2 font-bold px-8">Refresh Global Data</Button>
            </Card>
          </TabsContent>
        ))}
      </Tabs>
