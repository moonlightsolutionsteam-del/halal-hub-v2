  ...
  return (
    <div className="container mx-auto p-6 space-y-8 max-w-7xl pb-24">
      <div className="space-y-1">
        <h1 className="text-3xl font-black font-headline text-slate-900 uppercase tracking-tighter text-emerald-600">Mosque & Community Centers</h1>
        <p className="text-muted-foreground font-medium text-lg italic">Platform oversight for masjids, prayer sync logs, and donation transparency.</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Active Masjids</span>
                <div className="h-10 w-10 rounded-2xl bg-emerald-50 flex items-center justify-center text-emerald-600">
                  <Church className="h-5 w-5" />
                </div>
              </div>
              <div className="space-y-1">
                <p className="text-4xl font-black text-slate-900">452</p>
            ...
            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Prayer Sync Rate</span>
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase">Live timestamp sync</p>
              </div>
            </Card>

            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Active Donors</span>
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase">Across network</p>
              </div>
            </Card>
          </div>
                ...
                <TableBody>
                  {[
                    ...
                    <TableRow key={i} className="border-slate-100 hover:bg-slate-50/50 transition-colors">
                      <TableCell className="px-8 py-6 font-bold text-slate-800 text-sm">
                        {item.name}
                        <p className="text-[10px] text-slate-400 uppercase font-black tracking-widest">{item.city}</p>
                      </TableCell>
            ...
            <CardHeader className="p-8 border-b space-y-6">
              <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="relative w-full md:w-96">
                  ...
                  <Input placeholder="Search masjids by name, city or ID..." className="pl-9 h-12 rounded-2xl bg-slate-50 border-none font-medium" />
                </div>
              ...
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    <TableHead className="px-8 h-14 font-black text-[10px] uppercase tracking-widest text-slate-400">Masjid Identity</TableHead>
                ...
                <TableBody>
                  {MOCK_MOSQUES.map((msq) => (
                    <TableRow key={msq.id} className="border-slate-100 hover:bg-slate-50/50 transition-colors group">
                      <TableCell className="px-8 py-5">
                        <p className="font-black text-slate-800 text-base">{msq.name}</p>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10">
            <div className="space-y-10">
              <div className="space-y-2 border-b pb-6">
                <h3 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Religious & Social Standards</h3>
                <p className="text-muted-foreground font-medium text-lg italic">Global mandatory compliance criteria for masjid partners.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-5 bg-slate-50 rounded-2xl border border-transparent hover:border-emerald-200 transition-all cursor-pointer group shadow-sm">
                ...
                <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white space-y-6 relative overflow-hidden flex flex-col justify-between">
                  ...
                  <div className="space-y-2 relative z-10">
                    ...
                    <p className="text-slate-400 text-sm">Schedule board reviews for scholarly alignment and community standards.</p>
                  </div>
            ...
            <div className="lg:col-span-8 space-y-8">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10 space-y-10">
                <div className="flex items-center justify-between">
                  <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Trust & Fund Health</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-8 bg-slate-50 rounded-[2rem] space-y-2 border shadow-inner">
                    <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Platform Processing Fee</p>
                    <p className="text-4xl font-black text-slate-900">0.0% <span className="text-sm font-bold text-slate-400 italic">charity-only</span></p>
                    <p className="text-xs font-bold text-emerald-600">On all digital Sadaqah contributions</p>
                  </div>
                  <div className="p-8 bg-slate-50 rounded-[2rem] space-y-2 border shadow-inner">
                    <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Donation Volume (MTD)</p>
                    <p className="text-4xl font-black text-slate-900">₹18.4M</p>
                    <p className="text-xs font-bold text-slate-400 uppercase">Network-wide collections</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <h4 className="text-sm font-black uppercase text-slate-400 tracking-widest">Recent Distributions</h4>
                  <div className="divide-y border rounded-2xl overflow-hidden">
                    {[
                      ...
                      <div key={i} className="p-4 bg-white flex items-center justify-between text-xs font-bold hover:bg-slate-50 transition-colors">
                        <span className="text-slate-400">{set.id}</span>
                        <span className="text-slate-900 flex-1 px-8">{set.entity}</span>
            ...
            <div className="lg:col-span-4 space-y-8">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-slate-900 text-white p-8 space-y-8 relative overflow-hidden flex flex-col justify-between h-full">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <Button variant="outline" className="w-full border-white/20 text-white hover:bg-white/10 rounded-xl h-14 font-black uppercase text-xs tracking-widest">Audit Disbursement Rules</Button>
                </div>
              </Card>
            </div>
          </div>
