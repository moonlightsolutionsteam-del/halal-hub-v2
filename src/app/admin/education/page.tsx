      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
        ...
        <TabsContent value="dashboard" className="space-y-8 m-0 animate-in fade-in duration-500">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Verified Curriculums</span>
                <div className="h-10 w-10 rounded-2xl bg-emerald-50 flex items-center justify-center text-emerald-600">
                  <BookOpen className="h-5 w-5" />
                </div>
              </div>
              <div className="space-y-1">
                <p className="text-4xl font-black text-slate-900">58</p>
                <p className="text-[10px] font-bold text-slate-400 uppercase">91% accuracy score</p>
              </div>
            </Card>

            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Total Students</span>
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase">Platform enrollments</p>
              </div>
            </Card>
          </div>
              ...
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    <TableHead className="px-8 h-14 font-black uppercase text-[10px] tracking-widest text-slate-400">Institution</TableHead>
                    <TableHead className="h-14 font-black uppercase text-[10px] tracking-widest text-slate-400">Audit Scope</TableHead>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10">
            <div className="space-y-10">
              <div className="space-y-2 border-b pb-6">
                <h3 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Educational Integrity Standards</h3>
                <p className="text-muted-foreground font-medium text-lg italic">Global mandatory compliance criteria for institutional partners.</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-violet-600 text-white p-10 relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-8">
                  <div className="space-y-2">
                    ...
                    <h2 className="text-7xl font-black tracking-tighter">640k</h2>
            ...
            <div className="lg:col-span-4 space-y-8">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 space-y-6 flex flex-col justify-between">
                <div className="space-y-2">
                  <h3 className="text-xl font-black text-slate-900">Education Tiers</h3>
                  <p className="text-sm text-slate-500 font-medium italic">Manage how students and alumni earn Hub Coins for academic excellence.</p>
                </div>
                <div className="space-y-4">
                  {[
