...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Escalation Tracker</h1>
        <p className="text-muted-foreground">High-priority vendor issues and resolution workflows.</p>
      </div>
