...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Success Playbooks</h1>
        <p className="text-muted-foreground">Onboarding, upsell, and retention playbooks for CS teams.</p>
      </div>
