...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Churn Prevention</h1>
        <p className="text-muted-foreground">At-risk vendor identification and retention workflows.</p>
      </div>
