...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">MIS Reports</h1>
        <p className="text-muted-foreground">Management Information System reports and financial summaries.</p>
      </div>
