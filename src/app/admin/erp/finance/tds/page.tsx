...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">TDS Management</h1>
        <p className="text-muted-foreground">Tax Deducted at Source tracking, filings, and compliance.</p>
      </div>
