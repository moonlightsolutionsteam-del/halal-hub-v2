...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Data Privacy (DPDP)</h1>
        <p className="text-muted-foreground">User data requests, consent records, and privacy controls.</p>
      </div>
