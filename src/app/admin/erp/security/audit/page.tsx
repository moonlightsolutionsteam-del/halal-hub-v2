...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Permissions Audit</h1>
        <p className="text-muted-foreground">Role assignments, permission changes, and access reviews.</p>
      </div>
