...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Security Incidents</h1>
        <p className="text-muted-foreground">Reported security events, breach logs, and remediation status.</p>
      </div>
