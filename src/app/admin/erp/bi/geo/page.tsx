...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Geographic Intelligence</h1>
        <p className="text-muted-foreground">City-wise growth, coverage gaps, and regional performance.</p>
      </div>
