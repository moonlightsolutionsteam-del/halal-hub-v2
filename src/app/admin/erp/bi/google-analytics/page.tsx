...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Google Analytics</h1>
        <p className="text-muted-foreground">Web and app traffic insights from Google Analytics.</p>
      </div>
