...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Platform KPIs</h1>
        <p className="text-muted-foreground">Top-line key performance indicators across all platform verticals.</p>
      </div>
