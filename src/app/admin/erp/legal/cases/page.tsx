...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Legal Cases</h1>
        <p className="text-muted-foreground">Active and resolved legal matters and litigation tracking.</p>
      </div>
