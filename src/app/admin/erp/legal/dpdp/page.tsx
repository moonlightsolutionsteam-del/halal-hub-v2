...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">DPDP Compliance</h1>
        <p className="text-muted-foreground">Digital Personal Data Protection Act compliance and audits.</p>
      </div>
