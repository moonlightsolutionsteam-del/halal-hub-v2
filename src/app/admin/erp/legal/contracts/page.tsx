...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold font-headline">Contract Repository</h1>
        <p className="text-muted-foreground">All vendor, partner, and employee contracts in one place.</p>
      </div>
