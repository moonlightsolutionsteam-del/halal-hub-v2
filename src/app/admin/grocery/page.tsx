  ...
  return (
    <div className="container mx-auto p-6 space-y-8 max-w-7xl pb-24">
      <div className="space-y-1">
        <h1 className="text-3xl font-black font-headline text-slate-900 uppercase tracking-tighter">Grocery & Supermarkets</h1>
        <p className="text-muted-foreground font-medium text-lg italic">Manage retailers, departmental audits, and stock transparency.</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Active Stores</span>
            ...
            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Verified Inventory</span>
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase">84% audited</p>
              </div>
            </Card>

            <Card className="rounded-[2rem] border-none shadow-sm bg-white p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Digital GMV</span>
                <div className="h-10 w-10 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-600">
                  <Landmark className="h-5 w-5" />
                </div>
              </div>
              <div className="space-y-1">
                <p className="text-4xl font-black text-slate-900">₹12.4M</p>
                <p className="text-[10px] font-bold text-slate-400 uppercase">Vertical Gross Vol.</p>
              </div>
            </Card>
          </div>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white overflow-hidden">
            <CardHeader className="p-8 border-b space-y-6">
              <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="relative w-full md:w-96">
                  ...
                  <Input placeholder="Search stores by name, ID or city..." className="pl-9 h-12 rounded-2xl bg-slate-50 border-none font-medium" />
                </div>
            ...
            <CardContent className="p-0">
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    <TableHead className="px-8 h-14 font-black text-[10px] uppercase tracking-widest text-slate-400">Merchant Identity</TableHead>
                ...
                <TableBody>
                  {MOCK_STORES.map((store) => (
                    <TableRow key={store.id} className="border-slate-100 hover:bg-slate-50/50 transition-colors group">
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10">
            <div className="space-y-10">
              <div className="space-y-2 border-b pb-6">
                <h3 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Departmental Standards</h3>
                <p className="text-muted-foreground font-medium text-lg italic">Define the audit scope for specific retail sections (Meat, Bakery, Deli).</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white space-y-6 relative overflow-hidden flex flex-col justify-between">
                  ...
                  <div className="space-y-2 relative z-10">
                    ...
                    <p className="text-slate-400 text-sm">Automated schedule for departmental re-verifications.</p>
                  </div>
                  <Button variant="secondary" className="w-full rounded-xl font-black text-[10px] h-12 uppercase tracking-widest relative z-10 shadow-xl bg-white text-slate-900">Manage Audit Cycle</Button>
                </div>
              </div>
            </div>
          </Card>
              ...
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    ...
                    <TableHead className="h-14 font-black uppercase text-[10px] tracking-widest text-slate-400">Store & Content</TableHead>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <button className="rounded-[2.5rem] border-4 border-dashed border-slate-100 bg-slate-50/30 flex flex-col items-center justify-center p-12 text-center gap-4 hover:bg-white hover:border-primary/20 transition-all cursor-pointer group min-h-[300px]">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-slate-400 font-medium">Create seasonal or department deals</p>
              </div>
            </button>
          </div>
        </TabsContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-8">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 space-y-6 flex flex-col justify-between">
                <div className="space-y-2">
                  <h3 className="text-xl font-black text-slate-900">Retail Tiers</h3>
                  <p className="text-sm text-slate-500 font-medium italic">Manage how shoppers earn Hub Coins for grocery purchases.</p>
                </div>
                <div className="space-y-4">
                  {[
        ...
        <TabsContent value="categories" className="animate-in fade-in duration-500 m-0">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white overflow-hidden">
            <CardHeader className="p-8 border-b flex flex-row items-center justify-between">
              <div className="space-y-1">
                <CardTitle className="text-xl font-black text-slate-900">Aisle Taxonomy</CardTitle>
              ...
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    ...
                    <TableHead className="h-14 font-black text-[10px] uppercase tracking-widest text-slate-400">Managed SKUs</TableHead>
                ...
                <TableBody>
                  {[
                    ...
                    <TableRow key={i} className="border-slate-100 hover:bg-slate-50/50 transition-colors group">
                      ...
                      <TableCell className="font-bold text-slate-500 text-xs">{cat.count} items</TableCell>
                      <TableCell className="text-center">
              ...
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10 space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-8 bg-slate-50 rounded-[2rem] space-y-2 border shadow-inner">
                    ...
                    <p className="text-4xl font-black text-slate-900">2.5% <span className="text-sm font-bold text-slate-400 italic">flat</span></p>
                    <p className="text-xs font-bold text-emerald-600">On digital marketplace orders</p>
                  </div>
                  <div className="p-8 bg-slate-50 rounded-[2rem] space-y-2 border shadow-inner">
                    <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Gross Volume (MTD)</p>
                    <p className="text-4xl font-black text-slate-900">₹42.8M</p>
                    <p className="text-xs font-bold text-slate-400 uppercase">Supermarket vertical activity</p>
                  </div>
                </div>
                <div className="space-y-4">
            ...
            <div className="lg:col-span-4 space-y-8">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-slate-900 text-white p-8 space-y-8 relative overflow-hidden flex flex-col justify-between h-full">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <Button variant="outline" className="w-full border-white/20 text-white hover:bg-white/10 rounded-xl h-14 font-black uppercase text-xs tracking-widest">Audit Payout Rules</Button>
                </div>
              </Card>
            </div>
          </div>
