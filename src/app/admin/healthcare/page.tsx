  ...
  return (
    <div className="container mx-auto p-6 space-y-8 max-w-7xl pb-24">
      <div className="space-y-1">
        <h1 className="text-3xl font-black font-headline text-slate-900">Healthcare & Wellness</h1>
        <p className="text-muted-foreground font-medium text-lg">Manage clinical partners, ethical care standards, and wellness audits.</p>
      </div>
        ...
        {["all", "verification", "governance", "reviews", "offers", "loyalty", "certificates", "categories", "billing"].map((tab) => (
          <TabsContent key={tab} value={tab} className="animate-in fade-in duration-500 m-0">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-20 text-center space-y-6">
              ...
              <Button variant="outline" className="rounded-xl border-2 font-bold px-8">Sync Provider Data</Button>
            </Card>
          </TabsContent>
        ))}
      </Tabs>
