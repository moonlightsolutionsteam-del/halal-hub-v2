          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white overflow-hidden">
            <CardHeader className="p-8 border-b space-y-6">
              <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="relative w-full md:w-96">
                  ...
                  <Input placeholder="Search caterers by name, ID or specialty..." className="pl-9 h-12 rounded-2xl bg-slate-50 border-none font-medium" />
                </div>
            ...
            <CardContent className="p-0">
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    <TableHead className="px-8 h-14 font-black text-[10px] uppercase tracking-widest text-slate-400">Partner Identity</TableHead>
                ...
                <TableBody>
                  {MOCK_CATERERS.map((cat) => (
                    <TableRow key={cat.id} className="border-slate-100 hover:bg-slate-50/50 transition-colors group">
                      <TableCell className="px-8 py-5">
                        <p className="font-black text-slate-800 text-base">{cat.name}</p>
              ...
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    ...
                    <TableHead className="h-14 font-black uppercase text-[10px] tracking-widest text-slate-400">Partner & Event</TableHead>
                ...
                <TableBody>
                  {[
                    ...
                    <TableRow key={i} className="border-slate-100 hover:bg-slate-50/50 transition-colors group">
                      ...
                      <TableCell>
                        <p className="font-black text-slate-800 text-base">{rep.event}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <button className="rounded-[2.5rem] border-4 border-dashed border-slate-100 bg-slate-50/30 flex flex-col items-center justify-center p-12 text-center gap-4 hover:bg-white hover:border-primary/20 transition-all cursor-pointer group min-h-[300px]">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-slate-400 font-medium">Create seasonal or event bulk deals</p>
              </div>
            </button>
          </div>
        </TabsContent>
            ...
            <div className="lg:col-span-4 space-y-8">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 space-y-6 flex flex-col justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-slate-500 font-medium italic">Manage how clients earn Hub Coins for catering contracts.</p>
                </div>
                <div className="space-y-4">
                  {[
        ...
        <TabsContent value="categories" className="animate-in fade-in duration-500 m-0">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white overflow-hidden">
            <CardHeader className="p-8 border-b flex flex-row items-center justify-between">
              <div className="space-y-1">
                <CardTitle className="text-xl font-black text-slate-900">Service Taxonomy</CardTitle>
              ...
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-8 bg-slate-50 rounded-[2rem] space-y-2 border shadow-inner">
                    ...
                    <p className="text-3xl font-black text-slate-900">5.0% <span className="text-sm font-bold text-slate-400 italic">flat</span></p>
