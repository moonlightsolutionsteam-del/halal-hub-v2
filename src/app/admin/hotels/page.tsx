          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10">
            <div className="space-y-10">
              <div className="space-y-2 border-b pb-6">
                ...
                <p className="text-muted-foreground font-medium text-lg italic">Define the compliance criteria for halal property listings.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white space-y-6 relative overflow-hidden flex flex-col justify-between">
                  ...
                  <Button variant="secondary" className="w-full rounded-xl font-black text-[10px] h-12 uppercase tracking-widest relative z-10 shadow-xl bg-white text-slate-900">Manage Audit Queue</Button>
                </div>
              </div>
            </div>
          </Card>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-20 text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground font-medium max-w-sm mx-auto italic">
                  Advanced administrative engine for property ecosystem oversight.
                </p>
              </div>
