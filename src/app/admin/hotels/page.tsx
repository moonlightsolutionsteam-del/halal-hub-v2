  ...
  return (
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-7xl mx-auto pb-24">
      <div className="space-y-1">
        <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground uppercase tracking-tighter">Hotels & Homestays</h1>
        <p className="text-muted-foreground font-medium text-sm sm:text-lg italic">Manage halal hospitality partners, privacy charters, and guest trust.</p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
        ...
        <TabsContent value="dashboard" className="space-y-8 m-0 animate-in fade-in duration-500">
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-6">
            ...
            <Card className="rounded-[2rem] border-none shadow-sm bg-card p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Charter Signed</span>
            ...
            <Card className="rounded-[2rem] border-none shadow-sm bg-card p-8 group hover:shadow-md transition-all">
              <div className="flex justify-between items-start mb-4">
                <span className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Booking Revenue</span>
              ...
              <Table>
                <TableHeader className="bg-muted/50">
                  <TableRow className="border-none">
                    <TableHead className="px-8 h-14 font-black uppercase text-[10px] tracking-widest text-muted-foreground">Property</TableHead>
                    <TableHead className="h-14 font-black uppercase text-[10px] tracking-widest text-muted-foreground">Charter Version</TableHead>
                    <TableHead className="h-14 font-black uppercase text-[10px] tracking-widest text-muted-foreground text-center">Privacy Lvl</TableHead>
                ...
                <TableBody>
                  {[
                    ...
                    <TableRow key={i} className="border-border hover:bg-muted/50 transition-colors">
                      ...
                      <TableCell className="font-bold text-muted-foreground text-xs italic">{item.ver}</TableCell>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card">
            <CardHeader className="p-8 border-b space-y-6">
              <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="relative w-full md:w-96">
                  ...
                  <Input placeholder="Search hotels, IDs or cities..." className="pl-9 h-12 rounded-2xl bg-muted border-none font-medium" value={search} onChange={e => setSearch(e.target.value)} />
                </div>
            ...
            <CardContent className="p-0">
              <Table>
                <TableHeader className="bg-muted/50">
                  <TableRow className="border-none">
                    <TableHead className="px-8 h-14 font-black text-[10px] uppercase tracking-widest text-muted-foreground">Property Identity</TableHead>
                    ...
                    <TableHead className="h-14 font-black text-[10px] uppercase tracking-widest text-muted-foreground text-center">Lifetime Stays</TableHead>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10">
            <div className="space-y-10">
              <div className="space-y-2 border-b pb-6">
                <h3 className="text-3xl font-black text-foreground uppercase tracking-tight">Hospitality Charter Standards</h3>
                <p className="text-muted-foreground font-medium text-sm sm:text-lg italic">Define the mandatory compliance criteria for property partners.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="bg-zinc-900 rounded-[2.5rem] p-10 text-white space-y-6 relative overflow-hidden flex flex-col justify-between">
                  ...
                  <div className="space-y-2 relative z-10">
                    ...
                    <p className="text-muted-foreground text-sm">Schedule unannounced audits for properties with 'Elite' trust status.</p>
                  </div>
              ...
              <Table>
                <TableHeader className="bg-muted/50">
                  <TableRow className="border-none">
                    ...
                    <TableHead className="h-14 font-black uppercase text-[10px] tracking-widest text-muted-foreground">Property & Content</TableHead>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card key={i} className="rounded-[2.5rem] border-none shadow-sm bg-card flex flex-col justify-between border-2 border-transparent hover:border-primary/10 transition-all group">
                <CardHeader className="p-8 pb-4">
                  ...
                  <div className="flex items-center gap-2 pt-2">
                    ...
                    <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">• {offer.claims} Bookings</span>
                  </div>
                </CardHeader>
            ...
            <button className="rounded-[2.5rem] border-4 border-dashed border-border bg-muted/30 flex flex-col items-center justify-center p-12 text-center gap-4 hover:bg-card hover:border-primary/20 transition-all cursor-pointer group min-h-[300px]">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground font-medium">Create seasonal property deals</p>
              </div>
            </button>
          </div>
        </TabsContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-8">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-6 flex flex-col justify-between">
                <div className="space-y-2">
                  <h3 className="text-xl font-black text-foreground">Hospitality Tiers</h3>
                  <p className="text-sm text-muted-foreground font-medium italic">Manage how guests earn Hub Coins for stay bookings.</p>
                </div>
                <div className="space-y-4">
                  {[
              ...
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-8 bg-muted rounded-[2rem] space-y-2 border shadow-inner">
                    ...
                    <p className="text-3xl font-black text-foreground">10.0% <span className="text-sm font-bold text-muted-foreground italic">flat</span></p>
            ...
            <div className="lg:col-span-4 space-y-8">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-8 space-y-6 relative overflow-hidden flex flex-col justify-between h-full">
                ...
                <div className="relative z-10 space-y-2">
                  ...
                  <h2 className="text-3xl sm:text-5xl font-black tracking-tighter text-primary">₹12.4M</h2>
