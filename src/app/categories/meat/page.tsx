        ...
        <div className="lg:col-span-9 space-y-8">
          ...
          <div className="flex flex-col items-center justify-center py-6 sm:py-16 gap-4 sm:gap-6">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-black text-muted-foreground uppercase tracking-[0.2em]">End of Butcher List</p>
              <div className="h-1 w-12 bg-muted rounded-full" />
            </div>
            <Button variant="outline" className="rounded-full px-8 sm:px-16 font-black border-2 h-10 sm:h-16 hover:bg-red-600 hover:text-white hover:border-red-600 transition-all text-sm sm:text-lg shadow-sm">Load More Butchers</Button>
          </div>
        </div>
      </div>
    </div>
