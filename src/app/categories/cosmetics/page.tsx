        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-3">
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-1">
                <h1 className="text-5xl font-black font-headline text-foreground tracking-tight">Cosmetics & Beauty</h1>
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <div className="relative flex-1 md:w-96">
              ...
              <Input placeholder="Search serums, lipsticks, or brands..." className="pl-12 h-14 rounded-2xl bg-card border-none shadow-sm font-medium text-lg" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {MOCK_COSMETICS_BRANDS.map((brand) => (
              <Link key={brand.id} href={`/entities/${brand.id}`}>
                <Card className="group rounded-[3rem] border-none shadow-sm overflow-hidden bg-card hover:shadow-2xl transition-all duration-700 flex flex-col h-full border-2 border-transparent hover:border-rose-100/50">
                  ...
                  <CardFooter className="px-8 pb-8 pt-0 mt-auto">
                    <Button className="w-full bg-zinc-900 hover:bg-rose-600 text-white rounded-[1.5rem] font-black text-sm uppercase tracking-widest h-16 shadow-2xl transition-all group-hover:scale-[1.02]">
