    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-6xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Venue Support Center</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8">
        <div className="lg:col-span-8 space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 flex flex-col justify-between group hover:shadow-md transition-all cursor-pointer border-2 border-transparent hover:border-purple-100">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground font-medium leading-relaxed">Help with fire safety, halal hospitality charter, or trade licenses.</p>
              </div>
              <ArrowRight className="h-5 w-5 text-muted-foreground ml-auto mt-6 group-hover:text-purple-600 transition-colors" />
            </Card>
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 flex flex-col justify-between group hover:shadow-md transition-all cursor-pointer border-2 border-transparent hover:border-purple-100">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground font-medium leading-relaxed">Issues with your booking calendar, ticketing engine, or lead manager.</p>
              </div>
          ...
          <section className="space-y-6">
            <h2 className="text-xl font-black px-2 text-foreground">Event Organizer Knowledge Base</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="p-6 rounded-[2rem] bg-card border border-border flex items-center justify-between group cursor-pointer hover:shadow-md transition-all">
                  ...
                  <HelpCircle className="h-4 w-4 text-muted-foreground group-hover:text-purple-600 transition-colors" />
                </div>
              ))}
            </div>
          </section>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="p-8 bg-purple-50 rounded-[2.5rem] border-2 border-dashed border-purple-100 text-center space-y-4">
            <div className="h-12 w-12 bg-card rounded-full flex items-center justify-center mx-auto text-purple-600 shadow-sm">
