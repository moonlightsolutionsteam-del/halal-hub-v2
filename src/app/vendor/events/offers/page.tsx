...
export default function EventOffersPage() {
  const activeOffers = [
    { id: 1, title: "Winter Wedding Discount", code: "WINTERWED", discount: "₹25,000 OFF", type: "Full Venue", status: "Active", expires: "Dec 31, 2024", used: 12 },
    { id: 2, title: "Early Bird Expo Booth", code: "EARLYEXPO", discount: "15% OFF", type: "Booth Rental", status: "Active", expires: "Nov 30, 2024", used: 45 },
    { id: 3, title: "Corporate Seminar Deal", code: "CORP2024", discount: "Free A/V Package", type: "Day Pass", status: "Expired", expires: "Oct 30, 2024", used: 8 },
  ];
    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-5xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Event Promotions</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6">
        ...
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-8 space-y-4 relative overflow-hidden">
          ...
          <div className="space-y-4 relative z-10">
            ...
            <h2 className="text-xl font-black leading-snug">Feature your space on the Hub Home.</h2>
            <Button variant="secondary" className="w-full rounded-xl font-black text-[10px] uppercase h-10 bg-purple-600 text-white border-none">Upgrade Listing</Button>
          </div>
        </Card>
      </div>
