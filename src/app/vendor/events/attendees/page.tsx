...
export default function EventAttendeesPage() {
  const attendees = [
    ...
    { id: 4, name: "Nadia Khan", event: "Islamic Expo", status: "Checked-in", time: "Just now", type: "Guest" },
  ];
    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-6xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Guest & Attendees</h1>
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between px-2">
          <h2 className="text-xl font-black">Live Visitor Registry</h2>
