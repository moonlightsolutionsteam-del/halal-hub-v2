...
export default function MediaDashboard() {
  ...
  const quickActions = [
    ...
    { label: "Author Portal", icon: Users, color: "text-slate-500", bg: "bg-slate-50" },
  ...
  return (
    <div className="p-8 space-y-8 bg-[#F8FBF9] min-h-screen">
      <div className="space-y-1">
        <h1 className="text-3xl font-black font-headline text-slate-900">Bookstores &amp; Islamic Media Dashboard</h1>
                ...
                <TableBody>
                  {recentOrders.map((order, i) => (
                    <TableRow key={i} className="border-slate-100 hover:bg-slate-50/50 transition-colors">
                      ...
                      <TableCell className="font-bold text-slate-600 text-xs">{order.type}</TableCell>
            ...
            <CardContent className="px-0">
              <div className="p-4 bg-muted/30 rounded-2xl space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-black text-slate-800">The Prophet's Prayer</p>
