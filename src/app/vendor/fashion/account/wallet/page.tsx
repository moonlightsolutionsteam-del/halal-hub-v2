...
export default function FashionWalletPage() {
  const transactions = [
    { id: "FSH-TXN-101", type: "Order Settlement", date: "Nov 02, 2024", amount: "+₹12,450", status: "Completed" },
    { id: "FSH-TXN-102", type: "Marketplace Fee", date: "Nov 01, 2024", amount: "-₹625", status: "Completed" },
    { id: "FSH-TXN-103", type: "Brand Withdrawal", date: "Oct 30, 2024", amount: "-₹45,000", status: "Processing" },
  ];
    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-6xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground font-medium">Manage your design studio's earnings, payouts, and marketplace billing.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-10 space-y-10 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <Banknote className="h-32 w-32 text-pink-600" />
              </div>
              ...
              <div className="flex items-center gap-4 relative z-10 pt-4">
                ...
                <div>
                  <p className="text-[10px] font-black uppercase text-muted-foreground">Monthly Sales</p>
                  <p className="text-sm font-bold">+18.4% vs Last Month</p>
                </div>
              </div>
            </Card>
            ...
            <div className="grid grid-rows-2 gap-6">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 flex items-center justify-between group cursor-pointer hover:shadow-md transition-all">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Linked Bank</p>
                    <p className="text-sm font-bold text-foreground">HDFC •••• 1124</p>
                  </div>
                </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-8">
            ...
            <div className="p-4 bg-muted rounded-2xl border-2 border-transparent hover:border-pink-600 transition-all cursor-pointer group">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-muted-foreground tracking-widest uppercase">Current Account</p>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-6">
            ...
            <p className="text-xs text-muted-foreground font-medium leading-relaxed">
              Platform listing fee of 5% applies to all Marketplace Sales. Payouts for fashion brands are processed within 48 hours of order completion.
            </p>
            <Button variant="outline" className="w-full h-12 rounded-2xl border-2 font-black text-xs uppercase tracking-widest text-pink-600 border-pink-100 hover:bg-pink-50">
              View Billing Policy
            </Button>
          </Card>
        </div>
