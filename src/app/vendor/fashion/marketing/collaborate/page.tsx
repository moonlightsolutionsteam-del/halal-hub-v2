      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-slate-900 text-white p-8 space-y-6 relative overflow-hidden">
          ...
          <div className="space-y-2 relative z-10">
            ...
            <p className="text-sm text-slate-400 font-medium">You have 2 pending lookbook reviews.</p>
          </div>
        ...
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 flex flex-col justify-between group hover:shadow-md transition-all">
          <div className="space-y-1">
            ...
            <h2 className="text-3xl font-black text-slate-900">850k+</h2>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4">
          {influencers.map((influencer) => (
            <Card key={influencer.id} className="rounded-[2rem] border-none shadow-sm bg-white overflow-hidden border-2 border-transparent hover:border-pink-100 transition-all group">
              <div className="p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-6">
                  <Avatar className="h-16 w-16 border-2 border-slate-50 shadow-sm">
                    <AvatarImage src={`https://picsum.photos/seed/influencer-fsh${influencer.id}/100/100`} />
