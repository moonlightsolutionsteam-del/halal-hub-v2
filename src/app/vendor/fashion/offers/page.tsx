    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-5xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Campaigns & Promos</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6">
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <h2 className="text-3xl font-black text-foreground">₹1.2M</h2>
        ...
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <h2 className="text-3xl font-black text-foreground">650</h2>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          {activeOffers.map((offer) => (
            <Card key={offer.id} className="rounded-[2.5rem] border-none shadow-sm overflow-hidden bg-card hover:shadow-xl transition-all duration-500 border-2 border-transparent hover:border-pink-100">
              <div className="p-8 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex items-center gap-8">
                  <div className={`h-20 w-20 rounded-3xl ${offer.status === 'Active' ? 'bg-pink-50 text-pink-600' : 'bg-muted text-muted-foreground'} flex items-center justify-center shadow-inner`}>
