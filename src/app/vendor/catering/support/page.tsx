    ...
    <div className="container mx-auto p-6 space-y-8 max-w-6xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-black font-headline text-slate-900">Catering Support Center</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 flex flex-col justify-between group hover:shadow-md transition-all cursor-pointer border-2 border-transparent hover:border-blue-100">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-500 font-medium leading-relaxed">Help with logistics certificates, FSSAI catering license, or hygiene ratings.</p>
              </div>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 flex flex-col justify-between group hover:shadow-md transition-all cursor-pointer border-2 border-transparent hover:border-blue-100">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-500 font-medium leading-relaxed">Issues with your quote builder, digital bookings, or staff rosters.</p>
              </div>
          ...
          <section className="space-y-6">
            <h2 className="text-xl font-black px-2 text-slate-900">Catering Knowledge Base</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="p-6 rounded-[2rem] bg-white border border-slate-100 flex items-center justify-between group cursor-pointer hover:shadow-md transition-all">
                  ...
                  <HelpCircle className="h-4 w-4 text-slate-300 group-hover:text-blue-600 transition-colors" />
                </div>
              ))}
            </div>
          </section>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="p-8 bg-blue-50 rounded-[2.5rem] border-2 border-dashed border-blue-100 text-center space-y-4">
            <div className="h-12 w-12 bg-white rounded-full flex items-center justify-center mx-auto text-blue-600 shadow-sm">
