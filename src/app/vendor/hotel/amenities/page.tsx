...
export default function HotelAmenitiesPage() {
  const amenities = [
    ...
    { title: "Airport Shuttle", status: "Premium Only", desc: "VIP transport for suite guests", icon: Car, color: "text-slate-600", bg: "bg-slate-50" },
  ];
    ...
    <div className="container mx-auto p-6 space-y-8 max-w-6xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-black font-headline text-slate-900">Amenities & Services</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {amenities.map((item, i) => (
          <Card key={i} className="rounded-[2.5rem] border-none shadow-sm bg-white overflow-hidden group hover:shadow-xl transition-all duration-500 border-2 border-transparent hover:border-sky-100">
