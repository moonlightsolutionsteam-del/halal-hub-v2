...
export default function HotelSupportPage() {
  const activeTickets = [
    { id: "HTL-TKT-101", subject: "Halal hospitality charter audit query", status: "Under Review", date: "Nov 01, 2024", priority: "High" },
    { id: "HTL-TKT-102", subject: "Room availability sync issue", status: "Closed", date: "Oct 28, 2024", priority: "Medium" },
  ];
    ...
    <div className="container mx-auto p-6 space-y-8 max-w-6xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-black font-headline text-slate-900">Hotel Support Center</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 flex flex-col justify-between group hover:shadow-md transition-all cursor-pointer border-2 border-transparent hover:border-sky-100">
              <div className="h-12 w-12 rounded-2xl bg-sky-50 flex items-center justify-center text-sky-600 mb-6">
                <ShieldCheck className="h-6 w-6" />
              </div>
              <div className="space-y-2">
                <h3 className="text-xl font-black text-slate-900">Trust Compliance</h3>
                <p className="text-sm text-slate-500 font-medium leading-relaxed">Help with the hospitality charter, F&B audits, or trade permits.</p>
              </div>
              <ArrowRight className="h-5 w-5 text-slate-300 ml-auto mt-6 group-hover:text-sky-600 transition-colors" />
            </Card>
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 flex flex-col justify-between group hover:shadow-md transition-all cursor-pointer border-2 border-transparent hover:border-sky-100">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-500 font-medium leading-relaxed">Issues with your booking engine, calendar sync, or payments.</p>
              </div>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm overflow-hidden bg-white">
            <CardHeader className="p-8 border-b flex flex-row items-center justify-between">
              ...
              <Button variant="ghost" className="font-bold text-sky-600">All Tickets <ArrowUpRight className="ml-2 h-4 w-4" /></Button>
            </CardHeader>
          ...
          <section className="space-y-6">
            <h2 className="text-xl font-black px-2 text-slate-900">Hotel Knowledge Base</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "Setting up private pool hours",
                "Halal hospitality charter compliance",
                "Syncing room inventory with OTAs",
                ...
                <div key={i} className="p-6 rounded-[2rem] bg-white border border-slate-100 flex items-center justify-between group cursor-pointer hover:shadow-md transition-all">
                  ...
                  <HelpCircle className="h-4 w-4 text-slate-300 group-hover:text-sky-600 transition-colors" />
                </div>
              ))}
            </div>
          </section>
            ...
            <div className="relative z-10 space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-400 font-medium leading-relaxed">
                  Our property support agents are available Mon-Sat, 9AM to 6PM for urgent operational assistance.
                </p>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10">
                  ...
                  <span className="text-sm font-bold">hotel-support@halalhub.com</span>
                </div>
              </div>
              <Button className="w-full bg-sky-600 hover:bg-sky-700 text-white rounded-2xl h-14 font-black text-xs uppercase tracking-widest shadow-xl">
                Chat With Us
              </Button>
            </div>
          </Card>

          <div className="p-8 bg-sky-50 rounded-[2.5rem] border-2 border-dashed border-sky-100 text-center space-y-4">
            <div className="h-12 w-12 bg-white rounded-full flex items-center justify-center mx-auto text-sky-600 shadow-sm">
              <Clock className="h-6 w-6" />
            </div>
            <p className="text-xs font-bold text-sky-600 uppercase tracking-widest">Avg. Response Time</p>
