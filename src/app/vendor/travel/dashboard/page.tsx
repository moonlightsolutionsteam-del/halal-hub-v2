...
export default function TravelVendorDashboard() {
  ...
  const quickActions = [
    ...
    { label: "Manage Tours", icon: Compass, color: "text-muted-foreground", bg: "bg-muted" },
  ...
  return (
    <div className="p-4 sm:p-8 space-y-6 sm:space-y-8 bg-background min-h-screen">
      <div className="space-y-1">
        <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Travel &amp; Tourism Dashboard</h1>
              ...
              <Table>
                <TableHeader className="bg-muted/50">
                  <TableRow className="border-none">
                    ...
                    <TableHead className="font-black uppercase text-[10px] tracking-widest text-muted-foreground">Package</TableHead>
                ...
                <TableBody>
                  {upcomingBookings.map((booking, i) => (
                    <TableRow key={i} className="border-border hover:bg-muted/50 transition-colors">
                      ...
                      <TableCell className="font-bold text-muted-foreground text-xs">{booking.tour}</TableCell>
            ...
            <CardContent className="px-0">
              <div className="p-4 bg-muted/30 rounded-2xl space-y-3">
                <div className="flex items-center gap-3">
                  <div className="h-8 w-8 bg-card rounded-full flex items-center justify-center text-primary font-black text-[10px] shadow-sm">FA</div>
                  <div>
                    <p className="text-xs font-black text-foreground">Faisal Ali</p>
