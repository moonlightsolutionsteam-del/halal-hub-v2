...
export default function TravelWalletPage() {
  const transactions = [
    { id: "TRV-TXN-101", type: "Tour Settlement", date: "Nov 02, 2024", amount: "+₹1,45,200", status: "Completed" },
    { id: "TRV-TXN-102", type: "Package Booking Fee", date: "Nov 01, 2024", amount: "-₹12,250", status: "Completed" },
    { id: "TRV-TXN-103", type: "Agency Withdrawal", date: "Oct 30, 2024", amount: "-₹2,50,000", status: "Processing" },
  ];
    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-6xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Wallet & Payouts</h1>
          <p className="text-muted-foreground font-medium">Manage agency earnings, tour package settlements, and payout bank accounts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8">
        <div className="lg:col-span-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-10 space-y-10 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <Banknote className="h-32 w-32 text-amber-600" />
              </div>
              ...
              <div className="flex items-center gap-4 relative z-10 pt-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold">+12.4% vs Last Month</p>
                </div>
              </div>
            </Card>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm overflow-hidden bg-card">
            <CardHeader className="p-8 border-b">
              <CardTitle className="text-xl font-black">Agency Transaction Ledger</CardTitle>
            </CardHeader>
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-8">
            ...
            <div className="p-4 bg-muted rounded-2xl border-2 border-transparent hover:border-amber-600 transition-all cursor-pointer group">
              <div className="flex items-center gap-4">
                <div className="h-10 w-10 bg-card rounded-xl flex items-center justify-center shadow-sm">
                  <Receipt className="h-5 w-5 text-muted-foreground" />
                </div>
                <div>
                  <p className="text-sm font-black text-foreground">HDFC Primary</p>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-6">
            ...
            <p className="text-xs text-muted-foreground font-medium leading-relaxed">
              Agency payouts occur 48 hours after tour completion for standard packages. Hajj/Umrah settlements follow the specific religious body agreement timelines.
            </p>
            <Button variant="outline" className="w-full h-12 rounded-2xl border-2 font-black text-xs uppercase tracking-widest text-amber-600 border-amber-100 hover:bg-amber-50">
              Full Payout Policy
            </Button>
          </Card>
        </div>
