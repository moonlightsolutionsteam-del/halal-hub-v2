    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-6xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Partner Network</h1>
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between px-2">
          ...
          <div className="relative w-full md:w-80">
            ...
            <Input placeholder="Search partners..." className="pl-9 h-11 rounded-2xl bg-card border-none shadow-sm font-medium" />
          </div>
        </div>

        <div className="grid grid-cols-1 gap-4">
          {partners.map((p) => (
            <Card key={p.id} className="rounded-[2rem] border-none shadow-sm bg-card overflow-hidden border-2 border-transparent hover:border-amber-100 transition-all group">
              <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-10">
                <div className="flex items-center gap-6">
                  <div className="h-16 w-16 bg-muted rounded-[1.5rem] flex items-center justify-center text-amber-600 group-hover:scale-110 transition-transform shadow-inner">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">• {p.location}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-12">
                  <div className="text-center md:text-right">
                    <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest mb-1">Audit Rating</p>
                    <div className="flex items-center gap-1.5 text-lg font-black text-foreground justify-center md:justify-end">
