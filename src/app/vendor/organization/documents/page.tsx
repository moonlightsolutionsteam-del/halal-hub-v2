...
const documents = [
  { name: "NGO Registration Certificate", status: "Verified", date: "Uploaded Jan 2024" },
  { name: "12A & 80G Tax Exemption", status: "Verified", date: "Uploaded Jan 2024" },
  { name: "Annual Financial Report 2025", status: "Pending Review", date: "Uploaded Mar 2026" },
]
    ...
    <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-8">
      <div className="flex items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-sm font-bold text-muted-foreground">Manage verification and compliance documents.</p>
        </div>
