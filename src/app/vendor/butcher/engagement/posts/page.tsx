    ...
    <div className="container mx-auto p-6 space-y-8 max-w-5xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-black font-headline text-foreground">Social Feed Posts</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card className="rounded-[2.5rem] border-4 border-dashed border-border bg-muted/50 flex flex-col items-center justify-center p-10 text-center gap-4 hover:bg-card hover:border-red-200 transition-all cursor-pointer group">
          ...
          <p className="font-black text-foreground">Upload Fresh Cut</p>
        </Card>
        ...
        <Card className="rounded-[2.5rem] border-4 border-dashed border-border bg-muted/50 flex flex-col items-center justify-center p-10 text-center gap-4 hover:bg-card hover:border-red-200 transition-all cursor-pointer group">
          ...
          <p className="font-black text-foreground">Post Butcher Reel</p>
        </Card>
        ...
        <Card className="rounded-[2.5rem] border-4 border-dashed border-border bg-muted/50 flex flex-col items-center justify-center p-10 text-center gap-4 hover:bg-card hover:border-red-200 transition-all cursor-pointer group">
          ...
          <p className="font-black text-foreground">Special Promo</p>
        </Card>
      </div>
              ...
              <div className="p-8 flex-1 flex flex-col justify-between">
                ...
                <div className="pt-8 flex flex-wrap items-center justify-between gap-4 border-t border-border">
                  <div className="flex gap-6">
                    ...
                    <div className="flex items-center gap-2 text-xs font-black text-muted-foreground uppercase tracking-widest">
                      <Eye className="h-4 w-4 text-muted-foreground" /> 850 Views
                    </div>
                  </div>
