...
export default function FinanceWalletPage() {
  const transactions = [
    { id: "FIN-WLT-101", type: "Portfolio Payout", date: "Nov 02, 2024", amount: "+₹1,45,200", status: "Completed" },
    { id: "FIN-WLT-102", type: "Marketplace Fee", date: "Nov 01, 2024", amount: "-₹12,250", status: "Completed" },
    { id: "FIN-WLT-103", type: "Institutional Withdraw", date: "Oct 30, 2024", amount: "-₹5,00,000", status: "Processing" },
  ];
    ...
    <div className="container mx-auto p-6 space-y-8 max-w-6xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground font-medium">Manage institutional liquidity, investment payouts, and regulatory billing.</p>
        </div>
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-10 space-y-10 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <Banknote className="h-32 w-32 text-indigo-600" />
              </div>
              <div className="space-y-2 relative z-10">
                <p className="text-xs font-black uppercase tracking-[0.2em] opacity-60">Settled Agency Balance</p>
                <h2 className="text-6xl font-black tracking-tighter">₹8,84,250</h2>
              </div>
              <div className="flex items-center gap-4 relative z-10 pt-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold">+12.4% YoY</p>
                </div>
              </div>
            </Card>
            ...
            <div className="grid grid-rows-2 gap-6">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 flex items-center justify-between group cursor-pointer hover:shadow-md transition-all">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Reserve Bank</p>
              ...
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 flex items-center justify-between group cursor-pointer hover:shadow-md transition-all">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-foreground">Fully Cleared</p>
                  </div>
                </div>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm overflow-hidden bg-card">
            <CardHeader className="p-8 border-b">
              <CardTitle className="text-xl font-black">Settlement Ledger</CardTitle>
            </CardHeader>
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-8">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-black uppercase text-muted-foreground tracking-widest">Active Accounts</h3>
              <Button size="icon" variant="ghost" className="rounded-xl bg-muted"><Plus className="h-4 w-4" /></Button>
            </div>
            <div className="p-4 bg-muted rounded-2xl border-2 border-transparent hover:border-indigo-600 transition-all cursor-pointer group">
              <div className="flex items-center gap-4">
                <div className="h-10 w-10 bg-card rounded-xl flex items-center justify-center shadow-sm">
                  <Receipt className="h-5 w-5 text-muted-foreground" />
                </div>
                <div>
                  <p className="text-sm font-black text-foreground">HDFC Business</p>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-6">
            <div className="flex items-center gap-3 text-amber-600">
              ...
              <h3 className="text-base font-black">Payout Policy</h3>
            </div>
            <p className="text-xs text-muted-foreground font-medium leading-relaxed">
              Institutional payouts are processed within 24 hours of clearing for standard accounts. Large-scale withdrawals over ₹1M require additional Shariah board verification.
            </p>
            <Button variant="outline" className="w-full h-12 rounded-2xl border-2 font-black text-xs uppercase tracking-widest text-indigo-600 border-indigo-100 hover:bg-indigo-50">
              View Fee Schedule
            </Button>
          </Card>
        </div>
