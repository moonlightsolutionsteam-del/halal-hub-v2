...
export default function EducationSupportPage() {
  const activeTickets = [
    { id: "EDU-TKT-101", subject: "Syllabus vetting delay", status: "Under Review", date: "Nov 01, 2024", priority: "High" },
    { id: "EDU-TKT-102", subject: "Updating term fee structure help", status: "Closed", date: "Oct 28, 2024", priority: "Medium" },
  ];
    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-6xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Admin Support Center</h1>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                "Gender segregation standards for facilities",
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-8 space-y-8 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <Button className="w-full bg-violet-600 hover:bg-violet-700 text-white rounded-2xl h-14 font-black text-xs uppercase tracking-widest shadow-xl">
                Chat With Concierge
              </Button>
            </div>
          </Card>
