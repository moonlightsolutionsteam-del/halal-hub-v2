  ...
  return (
    <div className="p-8 space-y-8 bg-[#F8FBF9] min-h-screen">
      <div className="space-y-1">
        <h1 className="text-3xl font-black font-headline text-slate-900">Education &amp; Training Dashboard</h1>
              ...
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    <TableHead className="px-8 font-black uppercase text-[10px] tracking-widest text-slate-400">Class / ID</TableHead>
                    <TableHead className="font-black uppercase text-[10px] tracking-widest text-slate-400">Teacher</TableHead>
                  ...
                  {upcomingClasses.map((cls, i) => (
                    <TableRow key={i} className="border-slate-100 hover:bg-slate-50/50 transition-colors">
                      <TableCell className="px-8 py-5">
                        <div className="font-bold text-slate-800 text-sm">{cls.subject}</div>
                        <div className="text-[9px] font-bold text-muted-foreground uppercase">{cls.id}</div>
                      </TableCell>
                      <TableCell className="font-bold text-slate-600 text-xs">{cls.teacher}</TableCell>
                      <TableCell className="font-bold text-slate-500 text-sm">{cls.time}</TableCell>
            ...
            <CardContent className="px-0">
              <div className="p-4 bg-muted/30 rounded-2xl space-y-3">
                <div className="flex items-center gap-3">
                  <div className="h-8 w-8 bg-white rounded-full flex items-center justify-center text-primary font-black text-[10px] shadow-sm">AA</div>
                  <div>
                    <p className="text-xs font-black text-slate-800">Aisha Abdullah</p>
