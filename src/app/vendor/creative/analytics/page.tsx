    ...
    <div className="container mx-auto p-4 sm:p-6 space-y-6 sm:space-y-10 max-w-6xl pb-24 text-foreground">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div className="space-y-1">
              <h1 className="text-2xl sm:text-4xl font-black font-headline tracking-tight text-foreground">Growth & Insights</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8">
        <div className="lg:col-span-8 space-y-8">
          ...
          <Card className="rounded-[3rem] border-none shadow-sm bg-card overflow-hidden h-[500px] flex items-center justify-center text-muted-foreground font-medium italic p-10 relative">
            <div className="absolute top-10 left-10 space-y-1">
              <h3 className="text-2xl font-black text-foreground">Reach Velocity</h3>
              <p className="text-sm font-bold text-muted-foreground uppercase tracking-widest">Total Impressions vs Engagement</p>
            </div>
            ...
            <div className="absolute bottom-10 left-10 right-10 flex justify-between items-center bg-muted p-6 rounded-3xl border border-border">
              <div className="flex gap-8">
                <div className="space-y-1">
                  <p className="text-[9px] font-black uppercase text-muted-foreground">Monthly Reach</p>
                  <p className="text-2xl font-black text-foreground">1.2M</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[9px] font-black uppercase text-muted-foreground">Total Interactions</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8">
              ...
              <div className="space-y-6">
                {[
                  { label: "Morning (Fajr-Dhuhr)", val: 15, color: "bg-muted" },
                  { label: "Afternoon (Asr-Maghrib)", val: 42, color: "bg-amber-400" },
                  { label: "Night (Isha-Midnight)", val: 43, color: "bg-zinc-900" },
                ].map((s, i) => (
                  <div key={i} className="space-y-2">
                    <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                      <span>{s.label}</span>
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-10 space-y-8 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="pt-4 border-t border-white/10">
                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-2">Top Performing Format</p>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8">
            <h3 className="text-xl font-black text-foreground">Interaction Points</h3>
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center justify-between group cursor-default">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-sm font-black text-foreground">{point.name}</span>
                  </div>
                  <span className="text-lg font-black text-foreground">{point.val}</span>
                </div>
              ))}
            </div>
          </Card>
