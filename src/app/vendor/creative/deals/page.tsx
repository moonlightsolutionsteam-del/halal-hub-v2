  ...
  return (
    <div className="container mx-auto p-6 space-y-10 max-w-6xl pb-24 text-slate-900">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div className="space-y-1">
              <h1 className="text-4xl font-black font-headline tracking-tight text-slate-900">Brand Deals & Ads</h1>
        ...
        <Button className="bg-slate-900 hover:bg-slate-800 rounded-full px-10 font-black shadow-lg h-16 text-white transition-all active:scale-95 text-lg">
          ...
          <Card key={deal.id} className="group rounded-[3rem] border-none shadow-sm overflow-hidden bg-white hover:shadow-xl transition-all duration-500 border-2 border-transparent hover:border-amber-100 flex flex-col h-full">
            <div className="p-8 flex-1 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <h3 className="text-2xl font-black text-slate-900 leading-tight group-hover:text-amber-600 transition-colors">{deal.title}</h3>
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">{deal.type}</p>
              </div>
              <div className="flex justify-between items-end border-t border-slate-50 pt-6">
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest mb-1">Contract Value</p>
                  <p className="text-2xl font-black text-slate-900">{deal.budget}</p>
                </div>
            ...
            <CardFooter className="p-8 pt-0">
              <Button className="w-full h-12 rounded-xl bg-slate-50 group-hover:bg-amber-600 text-slate-400 group-hover:text-white font-black text-[10px] uppercase tracking-widest shadow-none hover:shadow-xl transition-all">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        <Card className="rounded-[3rem] border-none shadow-sm bg-slate-900 text-white p-12 space-y-8 relative overflow-hidden group">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-slate-400 text-lg leading-relaxed italic max-w-md">
            ...
            <Button className="bg-white text-slate-900 hover:bg-slate-100 rounded-2xl h-14 px-10 font-black uppercase text-xs tracking-widest shadow-2xl mt-4">Enable Ad-Rev</Button>
          </div>
        </Card>

        <div className="space-y-8">
          <div className="px-4 space-y-2">
            <h3 className="text-2xl font-black text-slate-900">Verification Integrity</h3>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10 space-y-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-lg font-black text-slate-900 uppercase tracking-tighter">Verified Brands Only</h4>
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">Ethical Partnership Rule</p>
              </div>
            </div>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                  ...
                  <Badge className={cn("text-[9px] font-black uppercase border-none h-6", rule.active ? "bg-emerald-50 text-emerald-600" : "bg-slate-100 text-slate-400")}>
                    {rule.status}
                  </Badge>
                </div>
              ))}
