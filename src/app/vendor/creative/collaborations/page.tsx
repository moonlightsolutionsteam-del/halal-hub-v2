...
import { 
  ...
  ArrowUpRight, Plus, CheckCircle2, 
  UserPlus, ShieldCheck, Zap, HandHeart, 
  Info, Store, Briefcase, Landmark, 
  Smartphone, ArrowLeft, Star, Timer, 
  Clock, ChevronRight, Target, BarChart3,
...
const REQUESTS = [
  { id: 1, brand: "The Bosphorus Kitchen", type: "Fine Dining Feature", budget: "₹15,000", status: "New", date: "2h ago", match: 98, requirements: "1 Reel, 2 Stories", timeline: "Due in 14 days" },
  { id: 2, brand: "Pure Glow Beauty", type: "Skincare Series", budget: "₹45,000", status: "Priority", date: "5h ago", match: 92, requirements: "3 Reels, 1 Blog Post", timeline: "Due in 21 days" },
  { id: 3, brand: "Umrah Deluxe", type: "Vlog Sponsorship", budget: "₹1,20,000", status: "Draft", date: "Yesterday", match: 85, requirements: "Full Itinerary Feature", timeline: "Jan 2025" },
];
          ...
          <Tabs defaultValue="requests" className="w-full">
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-card p-2 rounded-2xl border shadow-sm mb-8 overflow-x-auto no-scrollbar">
              <TabsList className="bg-transparent h-auto p-0 gap-1 flex justify-start min-w-max">
                ...
                <TabsTrigger value="completed" className="rounded-xl px-8 py-3 font-black text-[10px] uppercase tracking-widest data-[state=active]:bg-primary data-[state=active]:text-white">Archive</TabsTrigger>
              </TabsList>
                    ...
                    <div className="flex-1 flex flex-col justify-between py-2 min-w-0">
                      ...
                      <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-8 border-t border-border mt-6">
                        ...
                        <div className="flex gap-2 w-full sm:w-auto">
                          <Button variant="outline" className="flex-1 sm:flex-none rounded-xl h-11 px-8 font-black text-[10px] uppercase tracking-widest border-2">Discuss Terms</Button>
                          <Button className="flex-1 sm:flex-none rounded-xl h-11 px-8 font-black text-[10px] uppercase tracking-widest bg-primary text-white shadow-lg shadow-primary/20">Accept Deal</Button>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <aside className="lg:col-span-4 space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8 group">
            ...
            <div className="space-y-6">
              {[
                { label: "Ethical Beauty", val: 95, color: "bg-rose-500", trend: "High Demand" },
                { label: "Heritage Travel", val: 78, color: "bg-amber-500", trend: "Growing" },
                { label: "Sunnah Wellness", val: 62, color: "bg-teal-500", trend: "Steady" },
              ].map((trend, i) => (
          ...
          <Card className="rounded-[2.5rem] border-none bg-zinc-900 text-white p-10 space-y-8 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <Button className="w-full h-14 rounded-2xl bg-primary hover:bg-primary/90 text-white font-black uppercase text-xs tracking-widest shadow-xl">Start Hub Audit</Button>
            </div>
          </Card>
