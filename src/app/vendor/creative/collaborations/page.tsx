...
import { 
  ...
  ArrowLeft, Star, Timer, ChevronRight,
  Target, BarChart3, Globe, Sparkles
} from "lucide-react"
    ...
    <div className="container mx-auto p-6 space-y-10 max-w-7xl pb-24 text-slate-900">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="space-y-1">
          <Link href="/vendor/creative/dashboard" className="flex items-center gap-2 text-sm font-black text-slate-400 hover:text-primary transition-colors w-fit">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div className="space-y-1">
              <h1 className="text-4xl font-black font-headline text-slate-900 tracking-tight">Collaborations Hub</h1>
