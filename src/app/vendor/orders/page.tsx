    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 max-w-5xl mx-auto pb-24">
      <div className="space-y-1">
        <div className="flex items-center gap-2 text-primary font-black uppercase tracking-widest text-[10px]">
          <ShoppingBag className="h-3 w-3" /> Operations
        </div>
        <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Orders</h1>
        <p className="text-muted-foreground font-medium">Track and manage incoming orders.</p>
      </div>
