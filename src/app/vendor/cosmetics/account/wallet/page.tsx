...
export default function CosmeticsWalletPage() {
  const transactions = [
    { id: "COS-TXN-101", type: "Store Payout", date: "Nov 02, 2024", amount: "+₹12,450", status: "Completed" },
    { id: "COS-TXN-102", type: "Marketplace Fee", date: "Nov 01, 2024", amount: "-₹625", status: "Completed" },
    { id: "COS-TXN-103", type: "Withdrawal Request", date: "Oct 30, 2024", amount: "-₹25,000", status: "Processing" },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-10 space-y-10 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <Banknote className="h-32 w-32 text-rose-600" />
              </div>
              ...
              <div className="flex items-center gap-4 relative z-10 pt-4">
                ...
                <div>
                  <p className="text-[10px] font-black uppercase text-muted-foreground">Growth this month</p>
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-8">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-black uppercase text-muted-foreground tracking-widest">Linked Accounts</h3>
              <Button size="icon" variant="ghost" className="rounded-xl bg-muted"><Plus className="h-4 w-4" /></Button>
            </div>
            <div className="p-4 bg-muted rounded-2xl border-2 border-transparent hover:border-rose-600 transition-all cursor-pointer group">
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-6">
            ...
            <p className="text-xs text-muted-foreground font-medium leading-relaxed">
              Brand payouts occur within 48 hours of order fulfillment. Hub marketplace fees are deducted automatically at checkout.
            </p>
            <Button variant="outline" className="w-full h-12 rounded-2xl border-2 font-black text-xs uppercase tracking-widest text-rose-600 border-rose-100 hover:bg-rose-50">
              View Fee Schedule
            </Button>
          </Card>
        </div>
