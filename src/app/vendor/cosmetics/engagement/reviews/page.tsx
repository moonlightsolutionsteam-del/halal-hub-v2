        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-slate-900 text-white p-8 space-y-6">
            <div className="flex items-center gap-3">
              <div className={`h-10 w-10 bg-white/10 rounded-xl flex items-center justify-center text-rose-600`}>
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between px-2">
            <div className="relative w-full md:w-80">
              ...
              <Input placeholder="Search beauty reviews..." className="pl-9 h-11 rounded-2xl bg-white border-none shadow-sm font-medium" />
            </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            {reviews.map((rev) => (
              <Card key={rev.id} className="rounded-[2.5rem] border-none shadow-sm bg-white overflow-hidden border-2 border-transparent hover:border-rose-100 transition-all group">
                <div className="p-8 space-y-6">
                  ...
                  {rev.response ? (
                    <div className="p-6 bg-slate-50 rounded-3xl border-l-4 border-rose-600 space-y-2">
