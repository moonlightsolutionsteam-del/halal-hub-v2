    ...
    <div className="container mx-auto p-6 space-y-8 max-w-6xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-black font-headline text-slate-900">Purity & Lab Transparency</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-rose-600 text-white p-10 text-center space-y-4">
          ...
          <Badge className="bg-white text-rose-600 font-black border-none uppercase text-[9px] px-4 py-1.5 rounded-full">TOP 1% Verified</Badge>
        </Card>
