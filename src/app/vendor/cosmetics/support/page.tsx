      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 flex flex-col justify-between group hover:shadow-md transition-all cursor-pointer border-2 border-transparent hover:border-rose-100">
              <div className="h-12 w-12 rounded-2xl bg-rose-50 flex items-center justify-center text-rose-600 mb-6">
                <ShieldCheck className="h-6 w-6" />
              </div>
              <div className="space-y-2">
                <h3 className="text-xl font-black text-slate-900">Lab & Audit</h3>
                <p className="text-sm text-slate-500 font-medium leading-relaxed">Help with lab report verification, ingredient analysis, and purity trust badges.</p>
              </div>
              <ArrowRight className="h-5 w-5 text-slate-300 ml-auto mt-6 group-hover:text-rose-600 transition-colors" />
            </Card>
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8 flex flex-col justify-between group hover:shadow-md transition-all cursor-pointer border-2 border-transparent hover:border-rose-100">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-500 font-medium leading-relaxed">Issues with your SKU manager, inventory sync, or marketplace payouts.</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="p-6 rounded-[2rem] bg-white border border-slate-100 flex items-center justify-between group cursor-pointer hover:shadow-md transition-all">
                  ...
                  <HelpCircle className="h-4 w-4 text-slate-300 group-hover:text-rose-600 transition-colors" />
                </div>
              ))}
            </div>
          </section>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="p-8 bg-rose-50 rounded-[2.5rem] border-2 border-dashed border-rose-100 text-center space-y-4">
            <div className="h-12 w-12 bg-white rounded-full flex items-center justify-center mx-auto text-rose-600 shadow-sm">
