...
export default function MarketingCollaboratePage() {
  const influencers = [
    { id: 1, name: "The Halal Shopper", specialty: "Grocery & Lifestyle", reach: "85k", rating: 4.9 },
    { id: 2, name: "Fatima's Kitchen", specialty: "Home Recipes & Ingredients", reach: "120k", rating: 4.8 },
    { id: 3, name: "Zaid's Healthy Life", specialty: "Organic & Wellness", reach: "45k", rating: 4.7 },
  ];
    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-6xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <Button className="bg-emerald-600 hover:bg-emerald-700 rounded-full px-8 font-black shadow-lg shadow-emerald-200 h-12 text-white">
          <Plus className="mr-2 h-4 w-4" /> Start Store Campaign
        </Button>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6">
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-8 space-y-6 relative overflow-hidden">
          ...
          <div className="space-y-2 relative z-10">
            ...
            <p className="text-sm text-muted-foreground font-medium">You have 1 pending store walk-through invitation.</p>
          </div>
        ...
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 flex flex-col justify-between group hover:shadow-md transition-all">
          <div className="space-y-1">
            ...
            <h2 className="text-3xl font-black text-foreground">450k+</h2>
        ...
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 flex flex-col justify-between group hover:shadow-md transition-all">
          <div className="space-y-1">
            ...
            <h2 className="text-3xl font-black text-foreground">12</h2>
            <p className="text-xs font-bold text-blue-600 uppercase">Creators reached out</p>
          </div>
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between px-2">
          <h2 className="text-xl font-black">Verified Retail Critics</h2>
        ...
        <div className="grid grid-cols-1 gap-4">
          {influencers.map((influencer) => (
            <Card key={influencer.id} className="rounded-[2rem] border-none shadow-sm bg-card overflow-hidden border-2 border-transparent hover:border-emerald-100 transition-all group">
              <div className="p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-6">
                  <Avatar className="h-16 w-16 border-2 border-border shadow-sm">
                    <AvatarImage src={`https://picsum.photos/seed/influencer-gro${influencer.id}/100/100`} />
                ...
                <div className="flex items-center gap-12">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button className="rounded-xl h-12 px-8 font-black uppercase text-[10px] tracking-widest bg-emerald-600 text-white shadow-lg shadow-emerald-200">Invite to Store</Button>
                  </div>
                </div>
              </div>
            </Card>
