    ...
    <div className="container mx-auto p-6 space-y-8 max-w-5xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-black font-headline text-slate-900">Store Social Feed</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card className="rounded-[2.5rem] border-4 border-dashed border-slate-100 bg-slate-50/50 flex flex-col items-center justify-center p-10 text-center gap-4 hover:bg-white hover:border-emerald-200 transition-all cursor-pointer group">
          ...
          <div className="space-y-1">
            <p className="font-black text-slate-900">Upload Stock Photo</p>
            <p className="text-xs text-slate-400 font-bold uppercase tracking-tighter">Fresh Arrivals</p>
          </div>
        </Card>
        ...
        <Card className="rounded-[2.5rem] border-4 border-dashed border-slate-100 bg-slate-50/50 flex flex-col items-center justify-center p-10 text-center gap-4 hover:bg-white hover:border-emerald-200 transition-all cursor-pointer group">
          ...
          <div className="space-y-1">
            <p className="font-black text-slate-900">Upload Store Reel</p>
            <p className="text-xs text-slate-400 font-bold uppercase tracking-tighter">Short Video</p>
          </div>
        </Card>
        ...
        <Card className="rounded-[2.5rem] border-4 border-dashed border-slate-100 bg-slate-50/50 flex flex-col items-center justify-center p-10 text-center gap-4 hover:bg-white hover:border-emerald-200 transition-all cursor-pointer group">
          ...
          <div className="space-y-1">
            <p className="font-black text-slate-900">Schedule Promo</p>
            <p className="text-xs text-slate-400 font-bold uppercase tracking-tighter">Flash Sale</p>
          </div>
        </Card>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          {posts.map((post) => (
            <Card key={post.id} className="rounded-[2.5rem] border-none shadow-sm overflow-hidden bg-white flex flex-col md:flex-row hover:shadow-xl transition-all duration-500 border-2 border-transparent hover:border-emerald-100">
