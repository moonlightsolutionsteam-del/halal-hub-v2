    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-6xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground">Request Hub Services</h1>
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-card p-4 rounded-[2.5rem] shadow-sm">
        <div className="relative w-full md:w-96">
          ...
          <Input placeholder="Search services (Audit, Photo, etc)..." className="pl-9 h-11 rounded-2xl bg-muted border-none" />
        </div>
              ...
              <div className="flex-1 space-y-4">
                <div className="space-y-1">
                  <div className="flex justify-between items-start">
                    <h3 className="text-2xl font-black text-foreground tracking-tight">{service.title}</h3>
                  ...
                  <p className="text-sm font-bold text-muted-foreground uppercase tracking-widest leading-none">by {service.provider}</p>
                </div>
                <div className="flex items-center justify-between border-t border-border pt-6">
                  <div className="space-y-0.5">
                    <p className="text-[10px] font-black text-muted-foreground uppercase tracking-tighter">Investment</p>
                    <p className="text-2xl font-black text-foreground">{service.price}</p>
                  </div>
      ...
      <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-12 overflow-hidden relative">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="p-8 bg-card/5 rounded-[2rem] border border-white/10 text-center space-y-2">
              ...
              <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Verified Pros</p>
            </div>
            <div className="p-8 bg-card/5 rounded-[2rem] border border-white/10 text-center space-y-2">
              <p className="text-4xl font-black text-blue-400">24h</p>
              <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Initial Response</p>
            </div>
          </div>
        </div>
      </Card>
