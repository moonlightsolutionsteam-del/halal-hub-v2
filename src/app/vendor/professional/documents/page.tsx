...
const documents = [
  { name: "Medical License", status: "Verified", date: "Uploaded Jan 2024" },
  { name: "Professional Indemnity Insurance", status: "Verified", date: "Uploaded Jan 2024" },
  { name: "Clinic Registration Certificate", status: "Pending Review", date: "Uploaded Mar 2026" },
]
    ...
    <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-8">
      <div className="flex items-center justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground tracking-tight">Documents</h1>
          <p className="text-sm font-bold text-muted-foreground">Manage verification and licensing documents.</p>
        </div>
