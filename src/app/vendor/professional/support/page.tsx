  ...
  return (
    <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-8">
      <div className="space-y-1">
        <h1 className="text-2xl sm:text-3xl font-black font-headline text-foreground tracking-tight">Support Center</h1>
        <p className="text-sm font-bold text-muted-foreground">Get help managing your practice&apos;s panel.</p>
      </div>

      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        <Card className="rounded-[2rem] border-none shadow-soft text-center">
          <CardContent className="p-6 space-y-2">
            <MessageSquare className="h-6 w-6 text-violet-600 mx-auto" />
        ...
        <Card className="rounded-[2rem] border-none shadow-soft text-center">
          <CardContent className="p-6 space-y-2">
            <Mail className="h-6 w-6 text-violet-600 mx-auto" />
        ...
        <Card className="rounded-[2rem] border-none shadow-soft text-center">
          <CardContent className="p-6 space-y-2">
            <Phone className="h-6 w-6 text-violet-600 mx-auto" />
      ...
      <Card className="rounded-[2rem] border-none shadow-soft">
        <CardHeader>
          <CardTitle className="text-lg font-black flex items-center gap-2">
            <Headset className="h-5 w-5 text-violet-600" />Submit a Ticket
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="subject">Subject</Label>
            <Input id="subject" placeholder="e.g., Unable to update appointment slots" />
          </div>
          <div className="space-y-2">
