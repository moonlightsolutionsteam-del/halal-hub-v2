...
export default function HealthcareWalletPage() {
  const transactions = [
    { id: "HC-WLT-101", type: "Service Settlement", date: "Nov 02, 2024", amount: "+₹12,450", status: "Completed" },
    { id: "HC-WLT-102", type: "Pharmacy Payout", date: "Nov 01, 2024", amount: "+₹4,200", status: "Completed" },
    { id: "HC-WLT-103", type: "Facility Withdrawal", date: "Oct 30, 2024", amount: "-₹25,000", status: "Processing" },
  ];
    ...
    <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 max-w-6xl mx-auto pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground font-medium">Manage clinical earnings, pharmacy settlements, and facility payout bank accounts.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-10 space-y-10 relative overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <Banknote className="h-32 w-32 text-teal-600" />
              </div>
              <div className="space-y-2 relative z-10">
                <p className="text-xs font-black uppercase tracking-[0.2em] opacity-60">Settled Account Balance</p>
                <h2 className="text-6xl font-black tracking-tighter">₹64,250</h2>
              </div>
              <div className="flex items-center gap-4 relative z-10 pt-4">
                ...
                <div>
                  <p className="text-[10px] font-black uppercase text-muted-foreground">Monthly Growth</p>
                  <p className="text-sm font-bold">+15.4%</p>
                </div>
              </div>
            </Card>
            ...
            <div className="grid grid-rows-2 gap-6">
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 flex items-center justify-between group cursor-pointer hover:shadow-md transition-all">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Facility Bank</p>
                    <p className="text-sm font-bold text-foreground">ICICI •••• 1124</p>
                  </div>
                </div>
              ...
              <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 flex items-center justify-between group cursor-pointer hover:shadow-md transition-all">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">Audit Status</p>
                    <p className="text-sm font-bold text-foreground">Financial Cleared</p>
                  </div>
                </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-8">
            ...
            <div className="p-4 bg-muted rounded-2xl border-2 border-transparent hover:border-teal-600 transition-all cursor-pointer group">
              <div className="flex items-center gap-4">
                <div className="h-10 w-10 bg-card rounded-xl flex items-center justify-center shadow-sm">
                  <Receipt className="h-5 w-5 text-muted-foreground" />
                </div>
                <div>
                  <p className="text-sm font-black text-foreground">HDFC Healthcare</p>
                  <p className="text-[10px] font-bold text-muted-foreground tracking-widest uppercase">•••• 1124</p>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-8 space-y-6">
            <div className="flex items-center gap-3 text-amber-600">
              ...
              <h3 className="text-base font-black">Billing Policy</h3>
            </div>
            <p className="text-xs text-muted-foreground font-medium leading-relaxed">
              Standard clinical payout window is 48 hours. Marketplace fees for wellness packages are deducted at source. Review your service tier for full commission details.
            </p>
            <Button variant="outline" className="w-full h-12 rounded-2xl border-2 font-black text-xs uppercase tracking-widest text-teal-600 border-teal-100 hover:bg-teal-50">
              Fee Schedule
            </Button>
          </Card>
        </div>
