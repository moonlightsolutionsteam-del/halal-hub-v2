...
export default function HealthcareDashboard() {
  const kpis = [
    ...
    { label: "Pending Appointments", value: "12", trend: "Action required", icon: Calendar, variant: "destructive" as const },
    { label: "Compliance Score", value: "99.8%", trend: "Audit verified", icon: ShieldCheck },
    { label: "Avg. Rating", value: "4.9", trend: "from 450 reviews", icon: Star },
    ...
    { label: "Medicine Alerts", value: "3", trend: "Low stock", icon: Pill, variant: "warning" as const },
  ];
  ...
  const upcomingAppointments = [
    ...
    { id: "APP-7023", patient: "Yusuf Khan", service: "Nutrition Plan", time: "12:00 PM", status: "Pending" },
  ];

  const quickActions = [
    { label: "New Appt", icon: PlusCircle, color: "text-emerald-500", bg: "bg-emerald-50" },
    { label: "Patients", icon: Users, color: "text-blue-500", bg: "bg-blue-50" },
    { label: "Services", icon: Stethoscope, color: "text-purple-500", bg: "bg-purple-50" },
    { label: "Pharmacy", icon: Pill, color: "text-amber-500", bg: "bg-amber-50" },
    { label: "Marketing", icon: TrendingUp, color: "text-slate-500", bg: "bg-slate-50" },
  ...
  return (
    <div className="p-8 space-y-8 bg-[#F8FBF9] min-h-screen">
      <div className="space-y-1">
        <h1 className="text-3xl font-black font-headline text-slate-900">Healthcare &amp; Wellness Dashboard</h1>
        <p className="text-muted-foreground font-medium opacity-60">Manage your clinic, pharmacy, or wellness center services and patient care.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <Table>
                <TableHeader className="bg-slate-50/50">
                  <TableRow className="border-none">
                    <TableHead className="px-8 font-black uppercase text-[10px] tracking-widest text-slate-400">Patient / ID</TableHead>
        ...
        <div className="space-y-8">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8">
            <CardHeader className="px-0 pt-0">
              <CardTitle className="text-xl font-black">Service Demand</CardTitle>
            </CardHeader>
            <CardContent className="px-0 space-y-6">
              {[
                { name: "Hijama Therapy", status: "High Demand", val: 95 },
                { name: "General Consults", status: "Steady", val: 65, variant: "warning" },
                { name: "Pharmacy Sales", status: "Rising", val: 82 },
              ].map((item, i) => (
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-primary text-primary-foreground p-8 overflow-hidden relative">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-sm font-medium opacity-80 leading-relaxed">
                Build patient trust by displaying your medical and halal certifications prominently on your profile.
              </p>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-8">
            <CardHeader className="px-0 pt-0">
              <CardTitle className="text-xl font-black">Recent Feedback</CardTitle>
            </CardHeader>
            <CardContent className="px-0">
              <div className="p-4 bg-muted/30 rounded-2xl space-y-3">
                <div className="flex items-center gap-3">
                  <div className="h-8 w-8 bg-white rounded-full flex items-center justify-center text-primary font-black text-[10px] shadow-sm">SA</div>
                  <div>
                    <p className="text-xs font-black text-slate-800">Sarah Ahmed</p>
                    <p className="text-[10px] text-muted-foreground font-bold">Hijama Therapy • 1d ago</p>
                  </div>
                </div>
                <p className="text-[11px] text-slate-600 font-medium line-clamp-2 italic">
                  "The clinic was very professional and the practitioners were very knowledgeable about sunnah practices..."
                </p>
