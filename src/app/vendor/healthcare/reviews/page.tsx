      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-teal-600 font-black uppercase tracking-widest text-[10px]">
            <Star className="h-3 w-3" /> Patient Trust
          </div>
          <h1 className="text-3xl font-black font-headline text-foreground">Patient Feedback</h1>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-zinc-900 text-white p-8 space-y-6">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 bg-white/10 rounded-xl flex items-center justify-center text-teal-400">
