    ...
    <div className="container mx-auto p-6 space-y-8 max-w-6xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-3xl font-black font-headline text-slate-900">Patient Registry</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <Card key={i} className="rounded-3xl border-none shadow-sm p-8 bg-white flex items-center gap-6">
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between px-2">
          ...
          <div className="relative w-full md:w-80">
            ...
            <Input placeholder="Search patients..." className="pl-9 h-11 rounded-2xl bg-white border-none shadow-sm font-medium" />
          </div>
        </div>

        <div className="grid grid-cols-1 gap-4">
          {patients.map((p) => (
            <Card key={p.id} className="rounded-[2rem] border-none shadow-sm bg-white overflow-hidden border-2 border-transparent hover:border-teal-100 transition-all group">
              <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-12">
                  <div className="text-center md:text-right">
                    ...
                    <p className="text-sm font-black text-slate-900">2 days ago</p>
                  </div>
