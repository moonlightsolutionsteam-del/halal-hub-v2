...
export default function WelcomeHubPage() {
  return (
    <div className="min-h-screen bg-[#FBFBFB] selection:bg-primary/10 pb-32">
      {/* Hero Section */}
      <section className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center space-y-8">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000 space-y-6">
            <Badge variant="outline" className="px-6 py-2 rounded-full border-white/20 text-white font-black uppercase text-xs tracking-[0.3em] bg-white/5 backdrop-blur-md">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            ...
            <Link href="/partner/portal">
              <Button size="lg" variant="outline" className="h-16 px-12 rounded-2xl border-white/20 text-white hover:bg-white/10 font-black uppercase text-sm tracking-widest backdrop-blur-md">
                Join as Partner
              </Button>
            </Link>
          </div>
      ...
      <div className="container mx-auto px-6 -mt-20 relative z-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {STATS.map((stat, i) => (
            <Card key={i} className="rounded-[2.5rem] border-none shadow-2xl bg-white p-8 group hover:shadow-primary/10 transition-all duration-500">
              <div className="flex flex-col items-center text-center gap-4">
                <div className={cn("h-14 w-14 rounded-2xl flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform bg-slate-50", stat.color)}>
        ...
        <section className="space-y-12">
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 px-4">
            <div className="space-y-2 text-center md:text-left">
              <h2 className="text-4xl font-black text-slate-900 tracking-tight">Core Industries</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {VERTICALS.map((v, i) => (
              <Link key={i} href={`/categories/${v.slug}`}>
                <Card className="rounded-[3rem] border-none shadow-sm bg-white overflow-hidden group hover:shadow-2xl transition-all duration-700 h-full border-2 border-transparent hover:border-primary/10">
                  <div className="p-10 space-y-8 text-center flex flex-col items-center">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-2xl font-black text-slate-900 tracking-tight">{v.name}</h3>
                      <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">{v.desc}</p>
                    </div>
                    <div className="h-12 w-12 rounded-full border-2 border-slate-50 flex items-center justify-center text-slate-200 group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all">
        ...
        <section className="mt-32 space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Creator Studio Hub */}
            <Card className="rounded-[4rem] border-none bg-slate-900 text-white p-16 relative overflow-hidden group hover:shadow-2xl transition-all duration-700">
              ...
              <div className="relative z-10 space-y-10">
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-slate-400 font-medium leading-relaxed italic max-w-md">
                ...
                <Link href="/vendor/creative/dashboard" className="block">
                  <Button className="h-16 px-12 rounded-2xl bg-white text-slate-900 hover:bg-slate-100 font-black uppercase text-sm tracking-widest shadow-2xl transition-all active:scale-95">
                    Launch Studio
                  </Button>
                </Link>
              </div>
            ...
            <Card className="rounded-[4rem] border-none bg-emerald-600 text-white p-16 relative overflow-hidden group hover:shadow-2xl transition-all duration-700">
              ...
              <div className="relative z-10 space-y-10">
                <div className="space-y-4">
                  <Badge className="bg-white/20 text-white border-none font-black text-xs uppercase tracking-[0.2em] px-6 py-2 rounded-full backdrop-blur-md">FAMILY HUB</Badge>
                ...
                <Link href="/family-tree" className="block">
                  <Button className="h-16 px-12 rounded-2xl bg-slate-900 text-white hover:bg-slate-800 font-black uppercase text-sm tracking-widest shadow-2xl transition-all active:scale-95">
                    Enter Family Hub
                  </Button>
                </Link>
              </div>
        ...
        {/* Community Section */}
        <section className="mt-32 bg-white rounded-[4rem] p-16 shadow-sm border space-y-12">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            ...
            <h2 className="text-5xl font-black tracking-tighter text-slate-900">Join the Conversation</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-10 rounded-[2.5rem] bg-slate-50 border border-transparent hover:border-primary/20 hover:bg-white transition-all duration-500 group">
                <topic.icon className={cn("h-10 w-10 mb-6 transition-transform group-hover:scale-110", topic.color)} />
                <h3 className="text-2xl font-black text-slate-900 mb-2">{topic.title}</h3>
                <p className="text-slate-500 font-medium leading-relaxed mb-6 italic">"{topic.desc}"</p>
          ...
          <div className="text-center pt-8">
            <Link href="/community">
              <Button className="h-16 px-16 rounded-2xl bg-slate-900 text-white hover:bg-slate-800 font-black uppercase text-sm tracking-widest shadow-2xl transition-all">
                Enter Community Hub
              </Button>
            </Link>
          </div>
        ...
        <section className="mt-32 text-center space-y-10 pb-20">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button variant="outline" className="h-16 px-12 rounded-2xl border-2 border-slate-200 bg-white font-black uppercase text-sm tracking-widest shadow-sm">Merchant Sign Up</Button>
          </div>
        </section>
      </div>
    </div>
