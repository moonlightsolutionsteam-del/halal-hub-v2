...
const MOSQUES: Record<string, any> = {
  ...
  "mq2": {
    ...
    about: "Al-Rahman Islamic Centre is one of Brooklyn's most established mosques, serving the Dharavi community for four decades. Our comprehensive programs span formal education, social welfare, interfaith outreach, and community events year-round.",
