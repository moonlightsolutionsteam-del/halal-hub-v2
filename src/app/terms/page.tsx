...
export default function TermsPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-12 max-w-4xl pb-32 text-slate-900">
      <div className="flex flex-col gap-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-4xl font-black font-headline text-slate-900 tracking-tight">Terms & Privacy</h1>
          </div>
      ...
      <div className="grid grid-cols-1 gap-8">
        <div className="flex gap-4 overflow-x-auto pb-2 no-scrollbar">
          ...
          <Badge variant="outline" className="text-slate-400 border-slate-200 font-black text-[10px] px-4 py-2 uppercase tracking-widest rounded-xl">Privacy Policy</Badge>
          <Badge variant="outline" className="text-slate-400 border-slate-200 font-black text-[10px] px-4 py-2 uppercase tracking-widest rounded-xl">Vendor Agreement</Badge>
          <Badge variant="outline" className="text-slate-400 border-slate-200 font-black text-[10px] px-4 py-2 uppercase tracking-widest rounded-xl">Cookie Policy</Badge>
        </div>

        <section className="space-y-6">
          {sections.map((section, i) => (
            <Card key={i} className="rounded-[2.5rem] border-none shadow-sm bg-white p-10 space-y-6 hover:shadow-md transition-all">
        ...
        <Card className="rounded-[3rem] border-none bg-slate-900 text-white p-12 relative overflow-hidden flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="h-20 w-20 rounded-[2rem] bg-white/10 flex items-center justify-center text-primary border border-white/10 shadow-2xl shrink-0 group hover:rotate-12 transition-transform">
          ...
          <Button variant="outline" className="h-16 px-12 rounded-2xl border-2 border-white/20 text-white hover:bg-white/10 font-black uppercase text-sm tracking-widest relative z-10">Download PDF</Button>
        </Card>
      </div>
    </div>
  );
