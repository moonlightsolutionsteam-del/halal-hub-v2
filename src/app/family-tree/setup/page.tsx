    ...
    <div className="container mx-auto p-6 space-y-10 max-w-3xl pb-24">
      ...
      <div className="grid grid-cols-1 gap-8">
        {step === 1 && (
          <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="space-y-2">
              <h2 className="text-2xl font-black text-foreground">Step 1: Family Basics</h2>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8">
              <div className="space-y-4">
                ...
                <Input placeholder="e.g., The Al-Sayed Family" className="h-14 rounded-2xl bg-muted border-none font-black text-lg" />
              </div>
        ...
        {step === 2 && (
          <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="space-y-2">
              <h2 className="text-2xl font-black text-foreground">Step 2: Invite Core Members</h2>
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                <Card key={i} className="rounded-[2rem] border-none shadow-sm bg-card p-6 group hover:border-emerald-100 border-2 border-transparent transition-all cursor-pointer">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-6">
                      <div className={`h-14 w-14 rounded-2xl ${opt.bg} ${opt.color} flex items-center justify-center`}>
                        <opt.icon className="h-6 w-6" />
                      </div>
                      <span className="text-lg font-black text-foreground">{opt.label}</span>
                    </div>
        ...
        {step === 3 && (
          <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="space-y-2">
              <h2 className="text-2xl font-black text-foreground">Step 3: Assign Roles</h2>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card overflow-hidden">
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-4 bg-muted rounded-2xl">
                    <div className="flex items-center gap-4">
                      <div className="h-10 w-10 bg-card rounded-xl flex items-center justify-center font-black text-muted-foreground text-xs">M{i+1}</div>
                      <div>
                        <p className="text-sm font-black text-foreground">{m.name}</p>
                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-tighter">{m.role}</p>
                      </div>
                    </div>
              ...
              <CardFooter className="bg-muted p-8 flex justify-center border-t">
                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest text-center max-w-xs">Role permissions can be adjusted anytime by the Admin.</p>
              </CardFooter>
            </Card>
          </div>
        )}
