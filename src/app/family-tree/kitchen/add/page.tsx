    ...
    <div className="container mx-auto p-6 space-y-10 max-w-3xl pb-24 text-slate-900">
      ...
      <div className="grid grid-cols-1 gap-10">
        <section className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10 space-y-8">
            <div className="space-y-4">
              <Label className="font-bold text-xs uppercase tracking-widest text-slate-400">Recipe Title</Label>
              <Input placeholder="e.g., Grandma's Signature Biryani" className="h-14 rounded-2xl bg-slate-50 border-none font-black text-xl" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                <Label className="font-bold text-xs uppercase tracking-widest text-slate-400">Difficulty</Label>
            ...
            <div className="space-y-4">
              <Label className="font-bold text-xs uppercase tracking-widest text-slate-400">Recipe Photos</Label>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <button className="aspect-square rounded-3xl border-4 border-dashed border-slate-100 bg-slate-50 flex flex-col items-center justify-center gap-2 text-slate-300 hover:border-amber-300 hover:text-amber-600 transition-all group">
        ...
        <section className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
          ...
          <Card className="rounded-[2.5rem] border-none shadow-sm bg-white p-10 space-y-8">
            <div className="space-y-2">
              <Label className="font-bold text-xs uppercase tracking-widest text-slate-400">Ingredient List</Label>
              <Textarea 
                placeholder="List ingredients one by one (e.g., 500g Basmati Rice...)" 
                className="min-h-[150px] rounded-2xl bg-slate-50 border-none p-4 font-medium resize-none" 
              />
            </div>
            <div className="space-y-2">
              <Label className="font-bold text-xs uppercase tracking-widest text-slate-400">Cooking Steps</Label>
              <Textarea 
                placeholder="Describe the cooking process in detail..." 
                className="min-h-[200px] rounded-2xl bg-slate-50 border-none p-4 font-medium resize-none" 
              />
            </div>
          </Card>
        </section>
        ...
        <section className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
          <Card className="rounded-[2.5rem] border-none bg-slate-900 text-white p-10 space-y-6 relative overflow-hidden">
            ...
            <Textarea 
              ...
              className="bg-white/5 border-white/10 rounded-2xl min-h-[100px] text-white placeholder:text-slate-600" 
            />
          </Card>
        </section>
