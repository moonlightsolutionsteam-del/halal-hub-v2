    ...
    <div className={cn("container mx-auto p-6 space-y-10 max-w-6xl pb-24 transition-all duration-700", isKidsMode ? "bg-amber-50/30" : "bg-background")}>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="rounded-2xl px-6 font-black border-2 h-14 bg-card shadow-sm gap-2" onClick={() => setIsKidsMode(!isKidsMode)}>
            <SwitchCamera className="h-4 w-4 text-emerald-600" /> {isKidsMode ? "Parent View" : "Kids Mode"}
          </Button>
          <Link href="/family-tree/setup">
            <Button variant="outline" className="rounded-2xl px-8 font-black border-2 h-14 bg-card shadow-sm hover:bg-muted transition-all">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
        <TabsList className="bg-card border rounded-2xl h-16 p-1 shadow-sm w-full md:w-auto overflow-x-auto justify-start">
              ...
              <Link key={i} href={moment.url}>
                <Card className={cn("rounded-3xl border shadow-none p-5 transition-all hover:shadow-md cursor-pointer group h-full", moment.color, moment.border)}>
                  <div className="flex gap-4 items-center">
                    <div className="h-10 w-10 rounded-2xl bg-card/50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8 group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="text-2xl font-black text-foreground">Family Chat</h3>
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Active Discussion</p>
                  </div>
                </div>
                <Link href="/family-tree/chat">
                  <Button variant="ghost" size="icon" className="rounded-2xl bg-muted h-10 w-10"><ArrowUpRight className="h-5 w-5 text-emerald-600" /></Button>
                </Link>
              </div>
                ...
                {[
                  ...
                  <div key={i} className="flex gap-3 items-start p-3 bg-muted/50 rounded-2xl">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-black text-foreground">{msg.name}</p>
                      <p className="text-xs text-muted-foreground truncate italic">"{msg.text}"</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8 group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="text-2xl font-black text-foreground">Expenses</h3>
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Shared spending</p>
                  </div>
                </div>
                <Link href="/family-tree/expenses">
                  <Button variant="ghost" size="icon" className="rounded-2xl bg-muted h-10 w-10"><ArrowUpRight className="h-5 w-5 text-blue-600" /></Button>
                </Link>
              </div>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8 group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="text-2xl font-black text-foreground">Family Board</h3>
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Shared tasks</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-5 bg-muted/50 rounded-3xl border border-transparent hover:border-emerald-100 hover:bg-card hover:shadow-md transition-all cursor-pointer group/item">
                    <div className="flex items-center gap-5">
                      <div className={cn(
                        "h-4 w-4 rounded-full border-2",
                        item.priority ? "bg-amber-100 border-amber-500 animate-pulse" : "bg-card border-border"
                      )} />
                      <p className="text-base font-black text-foreground truncate">{item.title}</p>
                    </div>
                    <span className="text-[10px] font-black text-muted-foreground uppercase bg-card px-3 py-1 rounded-full shadow-sm">{item.time}</span>
                  </div>
                ))}
              </div>
            </Card>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8 group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="text-2xl font-black text-foreground">Wellness</h3>
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Health Tracker</p>
                  </div>
                </div>
                <Link href="/family-tree/health">
                  <Button variant="ghost" size="icon" className="rounded-2xl bg-muted h-10 w-10"><ArrowUpRight className="h-5 w-5 text-teal-600" /></Button>
                </Link>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Shared moments</p>
                  </div>
                </div>
                <Link href="/family-tree/gallery">
                  <Button variant="ghost" size="icon" className="rounded-2xl bg-muted h-10 w-10"><ArrowUpRight className="h-5 w-5 text-purple-600" /></Button>
                </Link>
              </div>
            ...
            <Card className="rounded-[2.5rem] border-none shadow-sm bg-card p-10 space-y-8 group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5">
                    <h3 className="text-2xl font-black text-foreground">Kitchen</h3>
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Heritage Vault</p>
                  </div>
                </div>
                <Link href="/family-tree/kitchen">
                  <Button variant="ghost" size="icon" className="rounded-2xl bg-muted h-10 w-10"><ArrowUpRight className="h-5 w-5 text-amber-600" /></Button>
                </Link>
              </div>
              <div className="grid grid-cols-2 gap-4">
                {[
        ...
        <TabsContent value="legacy" className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <Card className="rounded-[3rem] border-none shadow-sm bg-card p-10 space-y-10 flex flex-col justify-between group">
              <div className="space-y-8">
                <div className="flex items-center justify-between px-2">
                  <div className="space-y-1">
                    <h3 className="text-2xl font-black text-foreground tracking-tight">Connections</h3>
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Awaiting Verification</p>
                  </div>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-5 bg-muted rounded-[2rem] border border-transparent hover:border-emerald-100 hover:bg-card hover:shadow-lg transition-all duration-500 cursor-pointer group/conn">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-base font-black text-foreground leading-tight">{conn.name}</p>
                          <p className="text-[10px] font-bold text-muted-foreground uppercase mt-1 tracking-tighter">{conn.role}</p>
                        </div>
                      </div>
                      <ChevronRight className="h-5 w-5 text-muted-foreground group-hover/conn:text-emerald-600 group-hover/conn:translate-x-1 transition-all" />
                    </div>
                  ))}
                </div>
              </div>
              <Button variant="ghost" className="w-full font-black text-xs uppercase tracking-widest text-muted-foreground hover:text-emerald-600 hover:bg-emerald-50 h-14 rounded-2xl border-2 border-dashed border-border">View All Requests</Button>
            </Card>
          </div>
          ...
          <section className="space-y-8">
            <div className="flex items-center justify-between px-4">
              <div className="space-y-1">
                <h2 className="text-3xl font-black text-foreground tracking-tight">Lineage Map</h2>
                <p className="text-sm font-medium text-muted-foreground italic">Visual generational hierarchy spanning 5 centuries.</p>
              </div>
              <Link href="/family-tree/map">
                <Button variant="outline" className="rounded-2xl font-black text-xs uppercase tracking-[0.2em] border-2 h-14 px-10 bg-card hover:bg-emerald-600 hover:text-white hover:border-emerald-600 transition-all shadow-sm">
                  <Globe className="h-4 w-4 mr-2" /> Full Screen View
                </Button>
              </Link>
            </div>
            <Card className="rounded-[4rem] border-none shadow-xl bg-card h-[600px] flex items-center justify-center relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col items-center gap-16 scale-110 sm:scale-100 transition-transform duration-1000 group-hover:scale-[1.02]">
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="text-center space-y-1">
                    <p className="text-2xl font-black text-foreground tracking-tight">Dr. Ibrahim Al-Sayed</p>
                ...
                <div className="h-24 w-px bg-muted relative">
                  <div className="absolute top-full left-1/2 -translate-x-1/2 w-[400px] h-px bg-muted" />
                </div>
                  ...
                  {[1, 2, 3].map(i => (
                    <div key={i} className="flex flex-col items-center gap-4 relative">
                      ...
                      <div className="text-center">
                        <p className="text-sm font-black text-foreground">Member {i}</p>
                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-tighter">Direct Node</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="absolute top-10 right-10 flex flex-col gap-3">
                <Button size="icon" variant="secondary" className="h-12 w-12 rounded-2xl bg-card/80 backdrop-blur-md shadow-xl border border-white hover:bg-card"><Plus className="h-5 w-5" /></Button>
                <Button size="icon" variant="secondary" className="h-12 w-12 rounded-2xl bg-card/80 backdrop-blur-md shadow-xl border border-white hover:bg-card"><Filter className="h-5 w-5" /></Button>
              </div>
            </Card>
          </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <Card className="rounded-[3rem] border-none shadow-sm overflow-hidden bg-card">
                <CardHeader className="p-10 border-b flex flex-row items-center justify-between bg-muted/30">
                  ...
                  <Link href="/family-tree/lineage/history">
                    <Button variant="ghost" size="icon" className="rounded-2xl h-12 w-12 bg-card shadow-sm border hover:bg-muted"><History className="h-5 w-5 text-muted-foreground" /></Button>
                  </Link>
                </CardHeader>
                <CardContent className="p-0">
                  <div className="divide-y divide-slate-50">
                    {[
                      ...
                      <div key={i} className="p-8 flex items-center gap-6 hover:bg-muted/50 transition-all cursor-default group">
                        ...
                        <div className="flex-1 space-y-0.5">
                          <p className="text-base text-muted-foreground font-medium leading-tight">
                            <span className="font-black text-foreground">{log.user}</span> {log.action}
                          </p>
            ...
            <div className="lg:col-span-4 space-y-8">
              <Card className="rounded-[3rem] border-none shadow-sm bg-card p-10 space-y-8 group">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-5 bg-muted rounded-3xl border border-transparent hover:border-emerald-100 hover:bg-card hover:shadow-lg transition-all duration-500 cursor-pointer group/doc">
                      <div className="flex items-center gap-4">
                        <div className="h-12 w-12 bg-card rounded-2xl flex items-center justify-center text-muted-foreground group-hover/doc:text-emerald-600 shadow-sm transition-colors duration-500">
                          <FileText className="h-6 w-6" />
                        </div>
                        <div>
                          <p className="text-xs font-black text-foreground leading-tight group-hover/doc:text-emerald-600 transition-colors">{doc.name}</p>
                          <p className="text-[9px] font-bold text-muted-foreground uppercase mt-1">{doc.type} • {doc.size}</p>
                        </div>
                      </div>
                      <Download className="h-4 w-4 text-muted-foreground group-hover/doc:text-emerald-600 transition-all" />
                    </div>
                  ))}
                </div>
                <Link href="/family-tree/lineage/documents">
                  <Button className="w-full bg-zinc-900 hover:bg-zinc-800 text-white rounded-2xl h-16 font-black uppercase text-xs tracking-widest shadow-2xl group-hover:scale-[1.02] transition-transform">
              ...
              <Card className="rounded-[3rem] border-none bg-emerald-50 p-10 space-y-6 relative overflow-hidden border-2 border-emerald-100 shadow-inner">
                ...
                <Button variant="outline" className="w-full rounded-2xl font-black text-[10px] uppercase tracking-widest border-2 border-emerald-200 h-12 bg-card text-emerald-700 relative z-10 hover:bg-emerald-50">Read Privacy Charter</Button>
              </Card>
            </div>
          </div>
        </TabsContent>
