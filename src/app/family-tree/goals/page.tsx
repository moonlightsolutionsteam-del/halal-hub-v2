  ...
  return (
    <div className="container mx-auto p-6 space-y-8 max-w-5xl pb-24">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <h1 className="text-3xl font-black font-headline text-slate-900">Goals & Wellness</h1>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-white overflow-hidden flex flex-col group">
          <div className="p-10 space-y-8 flex-1">
            ...
            <div className="space-y-2">
              <h3 className="text-3xl font-black text-slate-900 tracking-tight">Family Well Project</h3>
              <p className="text-slate-500 font-medium leading-relaxed italic">"Raising funds together to build a water well in Gaza."</p>
            </div>
            <div className="space-y-4 pt-4">
              <div className="flex justify-between items-end">
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Raised So Far</p>
                  <p className="text-4xl font-black text-emerald-600 tracking-tighter">₹8,500</p>
                </div>
                <p className="text-sm font-bold text-slate-400">of ₹10,000</p>
              </div>
              <Progress value={85} className="h-3 bg-slate-50" />
            </div>
          </div>
          <CardFooter className="bg-slate-50 p-8 border-t">
            <Button className="w-full h-14 rounded-2xl bg-slate-900 text-white font-black uppercase text-xs tracking-widest shadow-xl">Contribute Coins</Button>
          </CardFooter>
        </Card>
        ...
        <Card className="rounded-[2.5rem] border-none shadow-sm bg-white overflow-hidden flex flex-col group">
          <div className="p-10 space-y-8 flex-1">
            ...
            <div className="space-y-2">
              <h3 className="text-3xl font-black text-slate-900 tracking-tight">50k Steps Week</h3>
              <p className="text-slate-500 font-medium leading-relaxed italic">"Let's stay active together this week before the winter starts!"</p>
            </div>
            <div className="space-y-6 pt-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50 rounded-2xl text-center">
                  <p className="text-2xl font-black text-blue-600">42,850</p>
                  <p className="text-[9px] font-black uppercase text-slate-400 tracking-widest">Group Steps</p>
                </div>
                <div className="p-4 bg-slate-50 rounded-2xl text-center">
                  <p className="text-2xl font-black text-slate-900">2</p>
                  <p className="text-[9px] font-black uppercase text-slate-400 tracking-widest">Days Left</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between items-center text-[10px] font-black uppercase text-slate-400 tracking-widest px-1">
                  ...
                  <span className="text-slate-900">85% Completed</span>
                </div>
      ...
      {/* Rewards Notice */}
      <Card className="rounded-[3rem] border-none bg-slate-900 text-white p-12 relative overflow-hidden flex flex-col md:flex-row items-center gap-10">
        <Trophy className="absolute -bottom-4 -right-4 h-48 w-48 opacity-10 text-amber-400" />
        <div className="h-24 w-24 rounded-[2rem] bg-white/10 flex items-center justify-center text-amber-400 border border-white/10 shadow-2xl shrink-0">
        ...
        <Button className="h-16 px-12 rounded-2xl bg-amber-400 hover:bg-amber-500 text-slate-900 font-black uppercase text-sm tracking-widest shadow-2xl relative z-10">Manage Rewards</Button>
      </Card>
    </div>
  );
}
