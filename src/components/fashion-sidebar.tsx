...
export function FashionSidebar() {
  ...
  const menuItems = [
    ...
    { title: "Order Management", icon: Truck, url: "#" },
    ...
    <Sidebar variant="sidebar" className="border-r bg-white">
      <SidebarHeader className="p-6 border-b">
        <Link href="/vendor/fashion/dashboard" className="flex items-center gap-3">
          ...
          <span className="font-black text-xl text-primary font-headline tracking-tight">Fashion Panel</span>
        </Link>
      </SidebarHeader>
      ...
      <SidebarFooter className="p-6 border-t bg-slate-50/50">
        <Link href="/" className="flex items-center gap-3 text-primary cursor-pointer hover:opacity-80 transition-opacity">
          <div className="h-10 w-10 bg-primary/10 rounded-full flex items-center justify-center text-primary font-black text-xs">MA</div>
          <div className="flex flex-col">
            <span className="text-sm font-bold">Modest Attire Co.</span>
