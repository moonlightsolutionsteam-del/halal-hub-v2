  ...
  const toolGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Events & Promotions", icon: PlusCircle, url: "/vendor/engagement/events" },
    ...
    <Sidebar variant="sidebar" className="border-r bg-card">
      <SidebarHeader className="p-6 border-b">
        <Link href="/vendor/butcher/dashboard" className="flex items-center gap-3">
          ...
          <span className="font-black text-xl text-foreground font-headline tracking-tight">Butcher Panel</span>
        </Link>
      </SidebarHeader>
        ...
        <SidebarMenu className="space-y-1 mb-4">
          <SidebarMenuItem>
            <SidebarMenuButton 
              ...
              className="h-10 font-bold rounded-lg text-muted-foreground hover:bg-muted data-[active=true]:bg-red-600 data-[active=true]:text-white transition-all"
            >
                    ...
                    {group.items.map((sub) => (
                      <SidebarMenuItem key={sub.title}>
                        <SidebarMenuButton 
                          ...
                          className="h-9 font-bold text-muted-foreground rounded-lg hover:text-red-600 hover:bg-red-50 transition-all"
                        >
                          <Link href={sub.url}>
      ...
      <SidebarFooter className="p-6 border-t bg-muted/50">
        <Link href="/" className="flex items-center gap-3 text-red-600 cursor-pointer hover:opacity-80 transition-opacity">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-bold text-foreground">Meat Bar Butcher</span>
